...
const en: Translations = {
  ...
  kanban: {
    ...
    newTaskTitle: "New task", newTaskTitleField: "Title", newTaskBody: "Description", createAction: "Create", newBoardAction: "New board", newBoardPrompt: "New board slug (lowercase letters, digits, dashes):", newBoardNamePrompt: "Board display name (optional):", 
  },
  projects: {
...
const zh: Translations = {
  ...
  kanban: {
    ...
    newTaskTitle: "新建任务", newTaskTitleField: "标题", newTaskBody: "描述", createAction: "创建", newBoardAction: "新建看板", newBoardPrompt: "新看板 slug（小写字母、数字、连字符）：", newBoardNamePrompt: "看板显示名（可选）：", 
  },
  projects: {
...
const zhHant: Translations = {
  ...
  kanban: {
    ...
    newTaskTitle: "新建工作", newTaskTitleField: "標題", newTaskBody: "描述", createAction: "建立", newBoardAction: "新建看板", newBoardPrompt: "新看板 slug（小寫字母、數字、連字號）：", newBoardNamePrompt: "看板顯示名（選填）：", 
  },
  projects: {
...
const ja: Translations = {
  ...
  kanban: {
    ...
    newTaskTitle: "新規タスク", newTaskTitleField: "タイトル", newTaskBody: "説明", createAction: "作成", newBoardAction: "新規ボード", newBoardPrompt: "新しいボードの slug（小文字・数字・ダッシュ）：", newBoardNamePrompt: "ボードの表示名（任意）：", 
  },
  projects: {
...
const ar: Translations = {
  ...
  kanban: {
    ...
    newTaskTitle: "مهمة جديدة", newTaskTitleField: "العنوان", newTaskBody: "الوصف", createAction: "إنشاء", newBoardAction: "لوحة جديدة", newBoardPrompt: "معرّف اللوحة الجديدة (أحرف صغيرة وأرقام وشرطات):", newBoardNamePrompt: "اسم العرض للوحة (اختياري):", 
  },
  projects: {
