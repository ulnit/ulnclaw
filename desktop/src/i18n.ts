...
export interface Translations {
  ...
  palette: {
    ...
    updateCheck: string; shortcuts: string; notifications: string; kanbanDispatch: string; kanbanDispatched: string; kanbanDispatchFailed: string; kanbanQuickAdd: string; kanbanQuickAddPrompt: string; kanbanQuickAdded: string; kanbanQuickAddFailed: string; toggleSidebar: string;
...
const en: Translations = {
  ...
  palette: {
    ...
    updateCheck: "Check for updates", shortcuts: "Keyboard shortcuts", notifications: "Notification history", kanbanDispatch: "Dispatch kanban tasks", kanbanDispatched: "Kanban dispatch: {spawned} spawned · {promoted} promoted · {reclaimed} reclaimed", kanbanDispatchFailed: "Kanban dispatch failed: {error}", kanbanQuickAdd: "New kanban task…", kanbanQuickAddPrompt: "Task title:", kanbanQuickAdded: "Kanban task created: {id} — {title}", kanbanQuickAddFailed: "Kanban task creation failed: {error}", toggleSidebar: "Toggle sidebar",
...
const zh: Translations = {
  ...
  palette: {
    ...
    updateCheck: "检查更新", shortcuts: "键盘快捷键", notifications: "通知历史", kanbanDispatch: "派发看板任务", kanbanDispatched: "看板派发：{spawned} 派生 · {promoted} 晋升 · {reclaimed} 回收", kanbanDispatchFailed: "看板派发失败：{error}", kanbanQuickAdd: "新建看板任务…", kanbanQuickAddPrompt: "任务标题：", kanbanQuickAdded: "已创建看板任务：{id} —— {title}", kanbanQuickAddFailed: "看板任务创建失败：{error}", toggleSidebar: "切换侧栏",
...
const zhHant: Translations = {
  ...
  palette: {
    ...
    updateCheck: "檢查更新", shortcuts: "鍵盤快捷鍵", notifications: "通知歷史", kanbanDispatch: "派發看板任務", kanbanDispatched: "看板派發：{spawned} 派生 · {promoted} 晉升 · {reclaimed} 回收", kanbanDispatchFailed: "看板派發失敗：{error}", kanbanQuickAdd: "新增看板任務…", kanbanQuickAddPrompt: "任務標題：", kanbanQuickAdded: "已建立看板任務：{id} —— {title}", kanbanQuickAddFailed: "看板任務建立失敗：{error}", toggleSidebar: "切換側欄",
...
const ar: Translations = {
  ...
  palette: {
    ...
    updateCheck: "فحص التحديثات", shortcuts: "اختصارات لوحة المفاتيح", notifications: "سجل الإشعارات", kanbanDispatch: "توزيع مهام كانبان", kanbanDispatched: "توزيع كانبان: {spawned} إطلاق · {promoted} ترقية · {reclaimed} استرداد", kanbanDispatchFailed: "فشل التوزيع: {error}", kanbanQuickAdd: "مهمة كانبان جديدة…", kanbanQuickAddPrompt: "عنوان المهمة:", kanbanQuickAdded: "تم إنشاء مهمة كانبان: {id} — {title}", kanbanQuickAddFailed: "فشل إنشاء مهمة كانبان: {error}", toggleSidebar: "تبديل الشريط الجانبي",
