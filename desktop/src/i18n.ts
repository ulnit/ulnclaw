...
const zhHant: Translations = {
  ...
  slash: {
    ...
    usage: "本工作階段的 token 用量", kanban: "新增看板任務（/kanban <標題>）", newSession: "開始新工作階段（桌面）", clear: "清空螢幕並開始新工作階段（桌面）", clearConfirm: "清空螢幕並開始新工作階段？目前工作階段仍保留在工作階段清單中。", insights: "跨工作階段用量分析（/insights [N] [--days N] [--source S]）", compress: "立即壓縮本工作階段上下文", skillFallback: "技能", doctor: "開啟診斷檢視", runs: "開啟執行檢視", projects: "開啟專案檢視", config: "開啟設定檢視", webhooks: "開啟 Webhooks 檢視", models: "開啟模型檢視", plugins: "開啟外掛檢視", archive: "歸檔目前工作階段", unarchive: "恢復（取消歸檔）目前工作階段", exportSession: "匯出目前工作階段（/export [md|html|json]）",
    resume: "恢復近期工作階段（桌面）",
  },
  boot: {
