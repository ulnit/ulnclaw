...
export interface Translations {
  chrome: {
    ...
    scSettings: string; scSidebar: string; scPalette: string; scFind: string; scFocus: string; scShortcuts: string; scRecall: string;
  };
  session: {
...
const en: Translations = {
  chrome: {
    ...
    scShortcuts: "Show this dialog", scRecall: "Recall sent prompts (composer)",
  },
  session: {
...
const zh: Translations = {
  chrome: {
    ...
    scShortcuts: "显示本对话框", scRecall: "回调已发送提示词（输入框）",
  },
  session: {
...
const zhHant: Translations = {
  chrome: {
    ...
    scShortcuts: "顯示本對話框", scRecall: "回撥已傳送提示詞（輸入框）",
  },
  session: {
...
const ja: Translations = {
  chrome: {
    ...
    scShortcuts: "このダイアログを表示", scRecall: "送信済みプロンプトを呼び出し（入力欄）",
  },
  session: {
...
const ar: Translations = {
  chrome: {
    ...
    scShortcuts: "إظهار هذا الحوار", scRecall: "استدعاء المطالبات المرسلة (المؤلف)",
  },
  session: {
