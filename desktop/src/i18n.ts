...
export interface Translations {
  ...
  session: {
    ...
    infoStarted: string; infoActivity: string; infoMessages: string; infoEndReason: string; infoTokens: string; infoChildren: string; infoCensus: string; infoDuration: string; infoFirstUser: string; infoLastMessage: string;
...
const en: Translations = {
  ...
  session: {
    ...
    infoStarted: "Started", infoActivity: "Last activity", infoMessages: "Messages", infoEndReason: "End reason", infoTokens: "Total tokens", infoChildren: "Forked children", infoCensus: "Message census", infoDuration: "Duration", infoFirstUser: "First message", infoLastMessage: "Last message",
...
const zh: Translations = {
  ...
  session: {
    ...
    infoStarted: "开始时间", infoActivity: "最后活动", infoMessages: "消息数", infoEndReason: "结束原因", infoTokens: "总 token 数", infoChildren: "分叉子会话", infoCensus: "消息分布", infoDuration: "时长", infoFirstUser: "首条消息", infoLastMessage: "最近消息",
...
const zhHant: Translations = {
  ...
  session: {
    ...
    infoStarted: "開始時間", infoActivity: "最後活動", infoMessages: "訊息數", infoEndReason: "結束原因", infoTokens: "總 token 數", infoChildren: "分叉子會話", infoCensus: "訊息分佈", infoDuration: "時長", infoFirstUser: "首條訊息", infoLastMessage: "最近訊息",
...
const ja: Translations = {
  ...
  session: {
    ...
    infoStarted: "開始", infoActivity: "最終アクティビティ", infoMessages: "メッセージ数", infoEndReason: "終了理由", infoTokens: "合計トークン", infoChildren: "フォークされた子セッション", infoCensus: "メッセージ内訳", infoDuration: "所要時間", infoFirstUser: "最初のメッセージ", infoLastMessage: "最後のメッセージ",
...
const ar: Translations = {
  ...
  session: {
    ...
    infoStarted: "بدأت", infoActivity: "آخر نشاط", infoMessages: "الرسائل", infoEndReason: "سبب الانتهاء", infoTokens: "إجمالي الرموز", infoChildren: "الجلسات المتفرعة", infoCensus: "إحصاء الرسائل", infoDuration: "المدة", infoFirstUser: "الرسالة الأولى", infoLastMessage: "الرسالة الأخيرة",
