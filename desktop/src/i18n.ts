...
export interface Translations {
  ...
  kanban: {
    ...
    renameBoardAction: string; renameBoardPrompt: string; removeBoardAction: string; removeBoardConfirm: string;
  };
  projects: {
...
const zh: Translations = {
  ...
  kanban: {
    ...
    newTaskTitle: "新建任务", newTaskTitleField: "标题", newTaskBody: "描述", createAction: "创建", newBoardAction: "新建看板", newBoardPrompt: "新看板 slug（小写字母、数字、连字符）：", newBoardNamePrompt: "看板显示名（可选）：", renameBoardAction: "重命名看板", renameBoardPrompt: "该看板的新显示名：", removeBoardAction: "删除看板", removeBoardConfirm: "删除看板 {board}？已归档任务仍保留在数据库中，看板本身将被删除。", 
  },
  projects: {
...
const zhHant: Translations = {
  ...
  kanban: {
    ...
    newTaskTitle: "新建工作", newTaskTitleField: "標題", newTaskBody: "描述", createAction: "建立", newBoardAction: "新建看板", newBoardPrompt: "新看板 slug（小寫字母、數字、連字號）：", newBoardNamePrompt: "看板顯示名（選填）：", renameBoardAction: "重新命名看板", renameBoardPrompt: "該看板的新顯示名：", removeBoardAction: "刪除看板", removeBoardConfirm: "刪除看板 {board}？已歸檔工作仍保留在資料庫中，看板本身將被刪除。", 
  },
  projects: {
