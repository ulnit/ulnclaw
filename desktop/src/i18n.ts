...
export interface Translations {
  chrome: {
    ...
    manageProcess: string; autostart: string; autostartFailed: string; popoutFailed: string; gatewayRespawned: string; reopenLast: string; charWarn: string; charLimit: string; charLimitExceeded: string; notifySystem: string; completionChime: string; hideToTray: string; replayOnboarding: string; cancel: string; save: string; delete: string;
