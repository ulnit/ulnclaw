...
export interface Translations {
  chrome: {
    ...
    scSettings: string; scSidebar: string; scPalette: string; scFind: string; scFocus: string; scShortcuts: string; scRecall: string; scSessionNav: string;
  };
  session: {
    ...
    dayToday: string; tokensTitle: string; filterPlaceholder: string; filterNoMatch: string; dayJumpTitle: string; showAll: string; showLess: string; groupYesterday: string; groupWeek: string; groupOlder: string;
    whenNow: string;
  };
  tools: { running: string; done: string; thinking: string; arguments: string; result: string; fallbackName: string };
  slash: { help: string; skills: string; tools: string; recap: string; title: string; usage: string; kanban: string; newSession: string; skillFallback: string; resume: string };
...
const en: Translations = {
  chrome: {
    ...
    scShortcuts: "Show this dialog", scRecall: "Recall sent prompts (composer)", scSessionNav: "Navigate the session list (sidebar)",
  },
  session: {
    ...
    whenNow: "now", dayToday: "Today", tokensTitle: "Total tokens: {tokens}", filterPlaceholder: "Filter sessions…", filterNoMatch: "No sessions match the filter", dayJumpTitle: "Jump to date", showAll: "Show all {count} sessions", showLess: "Show fewer", groupYesterday: "Yesterday", groupWeek: "Past 7 days", groupOlder: "Older",
  },
  ...
  slash: {
    ...
    usage: "this session's token usage", kanban: "add a kanban task (/kanban <title>)", newSession: "start a new session (desktop)", skillFallback: "skill",
  ...
  palette: {
    ...
    updateCheck: "Check for updates", shortcuts: "Keyboard shortcuts", notifications: "Notification history", kanbanDispatch: "Dispatch kanban tasks", kanbanDispatched: "Kanban dispatch: {spawned} spawned · {promoted} promoted · {reclaimed} reclaimed", kanbanDispatchFailed: "Kanban dispatch failed: {error}", kanbanQuickAdd: "New kanban task…", kanbanQuickAddPrompt: "Task title:", kanbanQuickAdded: "Kanban task created: {id} — {title}", kanbanQuickAddFailed: "Kanban task creation failed: {error}", toggleSidebar: "Toggle sidebar", themePicker: "Switch theme…", themePickerTitle: "Dashboard theme", themeFailed: "Theme load failed: {error}", fontPicker: "Switch font…", fontPickerTitle: "Dashboard font", fontFailed: "Font load failed: {error}",
...
const zh: Translations = {
  chrome: {
    ...
    scShortcuts: "显示本对话框", scRecall: "回调已发送提示词（输入框）", scSessionNav: "键盘浏览会话列表（侧栏）",
  },
  session: {
    ...
    whenNow: "刚刚", dayToday: "今天", tokensTitle: "总 token 数：{tokens}", filterPlaceholder: "筛选会话…", filterNoMatch: "没有匹配过滤的会话", dayJumpTitle: "跳转到日期", showAll: "显示全部 {count} 个会话", showLess: "收起", groupYesterday: "昨天", groupWeek: "近 7 天", groupOlder: "更早",
  },
  ...
  slash: {
    ...
    usage: "本会话的 token 用量", kanban: "添加看板任务（/kanban <标题>）", newSession: "开始新会话（桌面）", skillFallback: "技能",
    resume: "恢复近期会话（桌面）",
  },
  boot: {
  ...
  palette: {
    ...
    updateCheck: "检查更新", shortcuts: "键盘快捷键", notifications: "通知历史", kanbanDispatch: "派发看板任务", kanbanDispatched: "看板派发：{spawned} 派生 · {promoted} 晋升 · {reclaimed} 回收", kanbanDispatchFailed: "看板派发失败：{error}", kanbanQuickAdd: "新建看板任务…", kanbanQuickAddPrompt: "任务标题：", kanbanQuickAdded: "已创建看板任务：{id} —— {title}", kanbanQuickAddFailed: "看板任务创建失败：{error}", toggleSidebar: "切换侧栏", themePicker: "切换主题…", themePickerTitle: "仪表盘主题", themeFailed: "主题加载失败：{error}", fontPicker: "切换字体…", fontPickerTitle: "仪表盘字体", fontFailed: "字体加载失败：{error}",
...
const zhHant: Translations = {
  chrome: {
    ...
    scShortcuts: "顯示本對話框", scRecall: "回撥已傳送提示詞（輸入框）", scSessionNav: "鍵盤瀏覽工作階段清單（側欄）",
  },
  session: {
    ...
    whenNow: "剛剛", dayToday: "今天", tokensTitle: "總 token 數：{tokens}", filterPlaceholder: "篩選工作階段…", filterNoMatch: "沒有符合篩選的工作階段", dayJumpTitle: "跳轉到日期", showAll: "顯示全部 {count} 個工作階段", showLess: "收起", groupYesterday: "昨天", groupWeek: "近 7 天", groupOlder: "更早",
  },
  ...
  slash: {
    ...
    usage: "本工作階段的 token 用量", kanban: "新增看板任務（/kanban <標題>）", newSession: "開始新工作階段（桌面）", skillFallback: "技能",
    resume: "恢復近期工作階段（桌面）",
  },
  boot: {
  ...
  palette: {
    ...
    updateCheck: "檢查更新", shortcuts: "鍵盤快捷鍵", notifications: "通知歷史", kanbanDispatch: "派發看板任務", kanbanDispatched: "看板派發：{spawned} 派生 · {promoted} 晉升 · {reclaimed} 回收", kanbanDispatchFailed: "看板派發失敗：{error}", kanbanQuickAdd: "新增看板任務…", kanbanQuickAddPrompt: "任務標題：", kanbanQuickAdded: "已建立看板任務：{id} —— {title}", kanbanQuickAddFailed: "看板任務建立失敗：{error}", toggleSidebar: "切換側欄", themePicker: "切換主題…", themePickerTitle: "儀表盤主題", themeFailed: "主題載入失敗：{error}", fontPicker: "切換字體…", fontPickerTitle: "儀表盤字體", fontFailed: "字體載入失敗：{error}",
...
const ja: Translations = {
  chrome: {
    ...
    scShortcuts: "このダイアログを表示", scRecall: "送信済みプロンプトを呼び出し（入力欄）", scSessionNav: "セッション一覧をキー操作（サイドバー）",
  },
  session: {
    ...
    whenNow: "たった今", dayToday: "今日", tokensTitle: "総トークン数：{tokens}", filterPlaceholder: "セッションを絞り込み…", filterNoMatch: "フィルターに一致するセッションはありません", dayJumpTitle: "日付へジャンプ", showAll: "{count} 件のセッションをすべて表示", showLess: "折りたたむ", groupYesterday: "昨日", groupWeek: "過去 7 日間", groupOlder: "それ以前",
  },
  ...
  slash: {
    ...
    usage: "このセッションのトークン使用量", kanban: "カンバンタスクを追加（/kanban <タイトル>）", newSession: "新しいセッションを開始（デスクトップ）", skillFallback: "スキル",
...
const ar: Translations = {
  chrome: {
    ...
    scShortcuts: "إظهار هذا الحوار", scRecall: "استدعاء المطالبات المرسلة (المؤلف)", scSessionNav: "التنقل في قائمة الجلسات (الشريط الجانبي)",
  },
  session: {
    ...
    whenNow: "الآن", dayToday: "اليوم", tokensTitle: "إجمالي الرموز: {tokens}", filterPlaceholder: "تصفية الجلسات…", filterNoMatch: "لا توجد جلسات مطابقة للتصفية", dayJumpTitle: "الانتقال إلى التاريخ", showAll: "عرض كل الجلسات ({count})", showLess: "عرض أقل", groupYesterday: "أمس", groupWeek: "آخر 7 أيام", groupOlder: "أقدم",
  },
  ...
  slash: {
    ...
    usage: "استخدام الرموز لهذه الجلسة", kanban: "إضافة مهمة كانبان (/kanban <العنوان>)", newSession: "بدء جلسة جديدة (سطح المكتب)", skillFallback: "مهارة",
  ...
  palette: {
    ...
    updateCheck: "فحص التحديثات", shortcuts: "اختصارات لوحة المفاتيح", notifications: "سجل الإشعارات", kanbanDispatch: "توزيع مهام كانبان", kanbanDispatched: "توزيع كانبان: {spawned} إطلاق · {promoted} ترقية · {reclaimed} استرداد", kanbanDispatchFailed: "فشل التوزيع: {error}", kanbanQuickAdd: "مهمة كانبان جديدة…", kanbanQuickAddPrompt: "عنوان المهمة:", kanbanQuickAdded: "تم إنشاء مهمة كانبان: {id} — {title}", kanbanQuickAddFailed: "فشل إنشاء مهمة كانبان: {error}", toggleSidebar: "تبديل الشريط الجانبي", themePicker: "تبديل السمة…", themePickerTitle: "سمة لوحة التحكم", themeFailed: "فشل تحميل السمة: {error}", fontPicker: "تبديل الخط…", fontPickerTitle: "خط لوحة التحكم", fontFailed: "فشل تحميل الخط: {error}",
