...
export interface Translations {
  ...
  kanban: {
    ...
    renameBoardAction: string; renameBoardPrompt: string; removeBoardAction: string; removeBoardConfirm: string; workdirAction: string; workdirTitle: string; workdirCurrent: string; workdirNone: string; workdirUp: string; workdirClear: string; workdirUse: string; workdirFailed: string; workdirEmpty: string;
  };
  projects: {
...
const en: Translations = {
  ...
  kanban: {
    ...
    newTaskTitle: "New task", newTaskTitleField: "Title", newTaskBody: "Description", createAction: "Create", newBoardAction: "New board", newBoardPrompt: "New board slug (lowercase letters, digits, dashes):", newBoardNamePrompt: "Board display name (optional):", renameBoardAction: "Rename board", renameBoardPrompt: "New display name for this board:", removeBoardAction: "Remove board", removeBoardConfirm: "Remove board {board}? Archived tasks stay in the database; the board itself is deleted.", workdirAction: "Set board workdir", workdirTitle: "Board workdir", workdirCurrent: "Current workdir: {path}", workdirNone: "No workdir set yet — tasks fall back to the gateway default cwd.", workdirUp: "Up", workdirClear: "Clear", workdirUse: "Use this directory", workdirFailed: "Browse failed: {error}", workdirEmpty: "No subdirectories here.", 
  },
  projects: {
