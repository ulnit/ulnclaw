...
export interface Translations {
  ...
  kanban: {
    ...
    renameBoardAction: string; renameBoardPrompt: string; removeBoardAction: string; removeBoardConfirm: string; workdirAction: string; workdirTitle: string; workdirCurrent: string; workdirNone: string; workdirUp: string; workdirClear: string; workdirUse: string; workdirFailed: string; workdirEmpty: string; promoteAction: string; promotePrompt: string; reclaimAction: string; reclaimConfirm: string; runsTitle: string;
  };
  projects: {
