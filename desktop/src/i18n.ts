...
export interface Translations {
  ...
  syncPanel: { title: string; device: string; unnamed: string; gate: string; gateActive: string; gateInert: string; optedIn: string; noneOptedIn: string; fetchRemote: string; fetching: string; remoteUnavailable: string; remoteEmpty: string; fromWord: string; filesWord: string; };
...
const en: Translations = {
  ...
  syncPanel: { title: "Skills sync", device: "Device", unnamed: "unnamed", gate: "Gate", gateActive: "active", gateInert: "inert", optedIn: "Opted-in", noneOptedIn: "none (ulnclaw sync enable <skill>)", fetchRemote: "Fetch remote", fetching: "Fetching\u2026", remoteUnavailable: "Remote manifest unavailable", remoteEmpty: "Remote manifest is empty.", fromWord: "from", filesWord: "file(s)" },
...
const zh: Translations = {
  ...
  syncPanel: { title: "技能同步", device: "设备", unnamed: "未命名", gate: "闸门", gateActive: "活跃", gateInert: "未启用", optedIn: "已加入", noneOptedIn: "无（ulnclaw sync enable <skill>）", fetchRemote: "拉取远端", fetching: "拉取中…", remoteUnavailable: "远端清单不可用", remoteEmpty: "远端清单为空。", fromWord: "来自", filesWord: "个文件" },
...
const zhHant: Translations = {
  ...
  syncPanel: { title: "技能同步", device: "裝置", unnamed: "未命名", gate: "閘門", gateActive: "活躍", gateInert: "未啟用", optedIn: "已加入", noneOptedIn: "無（ulnclaw sync enable <skill>）", fetchRemote: "拉取遠端", fetching: "拉取中…", remoteUnavailable: "遠端清單不可用", remoteEmpty: "遠端清單為空。", fromWord: "來自", filesWord: "個檔案" },
...
const ar: Translations = {
  ...
  syncPanel: { title: "مزامنة المهارات", device: "الجهاز", unnamed: "بلا اسم", gate: "البوابة", gateActive: "نشطة", gateInert: "خاملة", optedIn: "المنضمّة", noneOptedIn: "لا شيء (ulnclaw sync enable <skill>)", fetchRemote: "جلب البعيد", fetching: "جارٍ الجلب…", remoteUnavailable: "قائمة المهارات البعيدة غير متاحة", remoteEmpty: "قائمة المهارات البعيدة فارغة.", fromWord: "من", filesWord: "ملف(ات)" },
