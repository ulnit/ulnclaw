...
export interface Translations {
  ...
  secretsPanel: { title: string; order: string; noneEnabled: string; configured: string; noCommand: string; bwsMissing: string; tokenPresent: string; tokenMissing: string; opMissing: string; bindingsWord: string; tokenOptional: string; preserve: string; };
...
const en: Translations = {
  ...
  secretsPanel: { title: "Secret sources", order: "Source order", noneEnabled: "no sources enabled", configured: "configured", noCommand: "no command set", bwsMissing: "bws NOT FOUND", tokenPresent: "token present", tokenMissing: "token MISSING", opMissing: "op NOT FOUND", bindingsWord: "bindings", tokenOptional: "no service token (interactive auth may work)", preserve: "Preserve existing" },
...
const zh: Translations = {
  ...
  secretsPanel: { title: "密钥源", order: "源顺序", noneEnabled: "未启用任何源", configured: "已配置", noCommand: "未设置命令", bwsMissing: "未找到 bws", tokenPresent: "令牌存在", tokenMissing: "令牌缺失", opMissing: "未找到 op", bindingsWord: "条绑定", tokenOptional: "无服务令牌（交互式认证仍可用）", preserve: "保留已有" },
...
const zhHant: Translations = {
  ...
  secretsPanel: { title: "金鑰源", order: "源順序", noneEnabled: "未啟用任何源", configured: "已配置", noCommand: "未設置命令", bwsMissing: "未找到 bws", tokenPresent: "令牌存在", tokenMissing: "令牌缺失", opMissing: "未找到 op", bindingsWord: "條綁定", tokenOptional: "無服務令牌（互動式認證仍可用）", preserve: "保留已有" },
