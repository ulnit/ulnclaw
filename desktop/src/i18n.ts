...
export interface Translations {
  ...
  session: {
    ...
    dayToday: string; tokensTitle: string; filterPlaceholder: string; filterNoMatch: string;
    whenNow: string;
  };
...
const en: Translations = {
  ...
  session: {
    ...
    whenNow: "now", dayToday: "Today", tokensTitle: "Total tokens: {tokens}", filterPlaceholder: "Filter sessions…", filterNoMatch: "No sessions match the filter",
  },
...
const zh: Translations = {
  ...
  session: {
    ...
    whenNow: "刚刚", dayToday: "今天", tokensTitle: "总 token 数：{tokens}", filterPlaceholder: "筛选会话…", filterNoMatch: "没有匹配过滤的会话",
  },
...
const zhHant: Translations = {
  ...
  session: {
    ...
    whenNow: "剛剛", dayToday: "今天", tokensTitle: "總 token 數：{tokens}", filterPlaceholder: "篩選工作階段…", filterNoMatch: "沒有符合篩選的工作階段",
  },
...
const ja: Translations = {
  ...
  session: {
    ...
    whenNow: "たった今", dayToday: "今日", tokensTitle: "総トークン数：{tokens}", filterPlaceholder: "セッションを絞り込み…", filterNoMatch: "フィルターに一致するセッションはありません",
  },
...
const ar: Translations = {
  ...
  session: {
    ...
    whenNow: "الآن", dayToday: "اليوم", tokensTitle: "إجمالي الرموز: {tokens}", filterPlaceholder: "تصفية الجلسات…", filterNoMatch: "لا توجد جلسات مطابقة للتصفية",
  },
