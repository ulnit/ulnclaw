...
export interface Translations {
  ...
  desktopShell: { aboutTitle: string; aboutBody: string; binaryNotFound: string; };
...
const en: Translations = {
  ...
  desktopShell: { aboutTitle: "About ulnclaw", aboutBody: "Desktop shell v{version} · gateway port {port} · binary: {binary}", binaryNotFound: "not found" },
...
const zh: Translations = {
  ...
  desktopShell: { aboutTitle: "关于 ulnclaw", aboutBody: "桌面外壳 v{version} · 网关端口 {port} · 二进制：{binary}", binaryNotFound: "未找到" },
...
const zhHant: Translations = {
  ...
  desktopShell: { aboutTitle: "關於 ulnclaw", aboutBody: "桌面外殼 v{version} · 閘道埠 {port} · 二進位：{binary}", binaryNotFound: "未找到" },
...
const ja: Translations = {
  ...
  desktopShell: { aboutTitle: "ulnclaw について", aboutBody: "デスクトップシェル v{version} · ゲートウェイポート {port} · バイナリ: {binary}", binaryNotFound: "見つかりません" },
...
const ar: Translations = {
  ...
  desktopShell: { aboutTitle: "حول ulnclaw", aboutBody: "غلاف سطح المكتب v{version} · منفذ البوابة {port} · الملف الثنائي: {binary}", binaryNotFound: "غير موجود" },
