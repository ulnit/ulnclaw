...
export interface Translations {
  ...
  config: {
    ...
    messagingTitle: string; messagingNote: string; messagingEnable: string; messagingDisable: string; messagingTest: string; messagingFailed: string;
  };
  doctor: {
