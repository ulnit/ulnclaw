...
export interface Translations {
  ...
  session: {
    ...
    dayToday: string; tokensTitle: string;
    whenNow: string;
  };
...
const en: Translations = {
  ...
  session: {
    ...
    whenNow: "now", dayToday: "Today", tokensTitle: "Total tokens: {tokens}",
  },
...
const zh: Translations = {
  ...
  session: {
    ...
    whenNow: "刚刚", dayToday: "今天", tokensTitle: "总 token 数：{tokens}",
  },
...
const zhHant: Translations = {
  ...
  session: {
    ...
    whenNow: "剛剛", dayToday: "今天", tokensTitle: "總 token 數：{tokens}",
  },
...
const ar: Translations = {
  ...
  session: {
    ...
    whenNow: "الآن", dayToday: "اليوم", tokensTitle: "إجمالي الرموز: {tokens}",
  },
