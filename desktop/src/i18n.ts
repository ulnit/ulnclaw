...
export interface Translations {
  ...
  session: {
    ...
    infoStarted: string; infoActivity: string; infoMessages: string; infoEndReason: string;
...
const en: Translations = {
  ...
  session: {
    ...
    infoStarted: "Started", infoActivity: "Last activity", infoMessages: "Messages", infoEndReason: "End reason",
...
const zh: Translations = {
  ...
  session: {
    ...
    infoStarted: "开始时间", infoActivity: "最后活动", infoMessages: "消息数", infoEndReason: "结束原因",
...
const zhHant: Translations = {
  ...
  session: {
    ...
    infoStarted: "開始時間", infoActivity: "最後活動", infoMessages: "訊息數", infoEndReason: "結束原因",
...
const ja: Translations = {
  ...
  session: {
    ...
    infoStarted: "開始", infoActivity: "最終アクティビティ", infoMessages: "メッセージ数", infoEndReason: "終了理由",
...
const ar: Translations = {
  ...
  session: {
    ...
    infoStarted: "بدأت", infoActivity: "آخر نشاط", infoMessages: "الرسائل", infoEndReason: "سبب الانتهاء",
