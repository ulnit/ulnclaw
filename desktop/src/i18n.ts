...
const zh: Translations = {
  ...
  palette: {
    ...
    updateCheck: "检查更新", shortcuts: "键盘快捷键", notifications: "通知历史", kanbanDispatch: "派发看板任务", kanbanDispatched: "看板派发：{spawned} 派生 · {promoted} 晋升 · {reclaimed} 回收", kanbanDispatchFailed: "看板派发失败：{error}", kanbanQuickAdd: "新建看板任务…", kanbanQuickAddPrompt: "任务标题：", kanbanQuickAdded: "已创建看板任务：{id} —— {title}", kanbanQuickAddFailed: "看板任务创建失败：{error}", toggleSidebar: "切换侧栏", themePicker: "切换主题…", themePickerTitle: "仪表盘主题", themeFailed: "主题加载失败：{error}",
...
const zhHant: Translations = {
  ...
  palette: {
    ...
    updateCheck: "檢查更新", shortcuts: "鍵盤快捷鍵", notifications: "通知歷史", kanbanDispatch: "派發看板任務", kanbanDispatched: "看板派發：{spawned} 派生 · {promoted} 晉升 · {reclaimed} 回收", kanbanDispatchFailed: "看板派發失敗：{error}", kanbanQuickAdd: "新增看板任務…", kanbanQuickAddPrompt: "任務標題：", kanbanQuickAdded: "已建立看板任務：{id} —— {title}", kanbanQuickAddFailed: "看板任務建立失敗：{error}", toggleSidebar: "切換側欄", themePicker: "切換主題…", themePickerTitle: "儀表盤主題", themeFailed: "主題載入失敗：{error}",
