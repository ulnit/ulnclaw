...
const zhHant: Translations = {
  ...
  palette: {
    ...
    updateCheck: "檢查更新", shortcuts: "鍵盤快捷鍵", notifications: "通知歷史", kanbanDispatch: "派發看板任務", kanbanDispatched: "看板派發：{spawned} 派生 · {promoted} 晉升 · {reclaimed} 回收", kanbanDispatchFailed: "看板派發失敗：{error}", kanbanQuickAdd: "新增看板任務…", kanbanQuickAddPrompt: "任務標題：", kanbanQuickAdded: "已建立看板任務：{id} —— {title}", kanbanQuickAddFailed: "看板任務建立失敗：{error}", toggleSidebar: "切換側欄", themePicker: "切換主題…", themePickerTitle: "儀表盤主題", themeFailed: "主題載入失敗：{error}", fontPicker: "切換字體…", fontPickerTitle: "儀表盤字體", fontFailed: "字體載入失敗：{error}", copySessionId: "複製工作階段 ID",
