...
export interface Translations {
  ...
  slash: { help: string; skills: string; tools: string; recap: string; title: string; usage: string; kanban: string; skillFallback: string; resume: string };
...
const en: Translations = {
  ...
  slash: {
    ...
    usage: "this session's token usage", kanban: "add a kanban task (/kanban <title>)", skillFallback: "skill",
...
const zh: Translations = {
  ...
  slash: {
    ...
    usage: "本会话的 token 用量", kanban: "添加看板任务（/kanban <标题>）", skillFallback: "技能",
    resume: "恢复近期会话（桌面）",
  },
  boot: {
...
const zhHant: Translations = {
  ...
  slash: {
    ...
    usage: "本工作階段的 token 用量", kanban: "新增看板任務（/kanban <標題>）", skillFallback: "技能",
    resume: "恢復近期工作階段（桌面）",
  },
  boot: {
...
const ja: Translations = {
  ...
  slash: {
    ...
    usage: "このセッションのトークン使用量", kanban: "カンバンタスクを追加（/kanban <タイトル>）", skillFallback: "スキル",
...
const ar: Translations = {
  ...
  slash: {
    ...
    usage: "استخدام الرموز لهذه الجلسة", kanban: "إضافة مهمة كانبان (/kanban <العنوان>)", skillFallback: "مهارة",
