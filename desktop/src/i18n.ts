...
export interface Translations {
  chrome: {
    ...
    manageProcess: string; autostart: string; autostartFailed: string; popoutFailed: string; gatewayRespawned: string; gatewayLogTitle: string; gatewayLogRefresh: string; gatewayLogClose: string; gatewayLogEmpty: string; reopenLast: string; charWarn: string; charLimit: string; charLimitExceeded: string; notifySystem: string; completionChime: string; hideToTray: string; replayOnboarding: string; cancel: string; save: string; delete: string;
  ...
  palette: {
    ...
    openSettings: string; refreshSessions: string; restartGateway: string; gatewayLog: string;
...
const en: Translations = {
  ...
  palette: {
    ...
    openSettings: "Open gateway settings…", refreshSessions: "Refresh session list", restartGateway: "Restart gateway", gatewayLog: "Show gateway log",
...
const zh: Translations = {
  chrome: {
    ...
    manageProcess: "管理网关进程（随应用启动/停止）", autostart: "登录时启动 ulnclaw", autostartFailed: "无法更改登录时启动设置。", popoutFailed: "无法打开会话窗口：{error}", gatewayRespawned: "网关已崩溃——已自动重新拉起。", gatewayLogTitle: "网关日志", gatewayLogRefresh: "刷新", gatewayLogClose: "关闭", gatewayLogEmpty: "尚未捕获到网关输出。", reopenLast: "启动时重新打开上次会话",
  ...
  palette: {
    ...
    openSettings: "打开网关设置…", refreshSessions: "刷新会话列表", restartGateway: "重启网关", gatewayLog: "查看网关日志",
...
const zhHant: Translations = {
  chrome: {
    ...
    manageProcess: "管理閘道程序（隨應用程式啟動/停止）", autostart: "登入時啟動 ulnclaw", autostartFailed: "無法變更登入時啟動設定。", popoutFailed: "無法開啟工作階段視窗：{error}", gatewayRespawned: "閘道已當機——已自動重新啟動。", gatewayLogTitle: "閘道日誌", gatewayLogRefresh: "重新整理", gatewayLogClose: "關閉", gatewayLogEmpty: "尚未擷取到閘道輸出。", reopenLast: "啟動時重新開啟上次工作階段",
  ...
  palette: {
    ...
    openSettings: "開啟閘道設定…", refreshSessions: "重新整理工作階段清單", restartGateway: "重啟閘道", gatewayLog: "檢視閘道日誌",
...
const ja: Translations = {
  chrome: {
    ...
    manageProcess: "ゲートウェイプロセスを管理（アプリと連動して起動/停止）", autostart: "ログイン時に ulnclaw を起動", autostartFailed: "ログイン時の起動設定を変更できませんでした。", popoutFailed: "セッションウィンドウを開けませんでした: {error}", gatewayRespawned: "ゲートウェイがクラッシュしました — 自動的に再起動しました。", gatewayLogTitle: "ゲートウェイログ", gatewayLogRefresh: "更新", gatewayLogClose: "閉じる", gatewayLogEmpty: "ゲートウェイの出力はまだありません。", reopenLast: "起動時に最後のセッションを再び開く",
  ...
  palette: {
    ...
    openSettings: "ゲートウェイ設定を開く…", refreshSessions: "セッション一覧を更新", restartGateway: "ゲートウェイを再起動", gatewayLog: "ゲートウェイログを表示",
...
const ar: Translations = {
  chrome: {
    ...
    manageProcess: "إدارة عملية البوابة (تشغيل/إيقاف مع التطبيق)", autostart: "تشغيل ulnclaw عند تسجيل الدخول", autostartFailed: "تعذر تغيير إعداد التشغيل عند تسجيل الدخول.", popoutFailed: "تعذر فتح نافذة الجلسة: {error}", gatewayRespawned: "انهارت البوابة — تمت إعادة تشغيلها تلقائيًا.", gatewayLogTitle: "سجل البوابة", gatewayLogRefresh: "تحديث", gatewayLogClose: "إغلاق", gatewayLogEmpty: "لم يتم التقاط أي إخراج للبوابة بعد.", reopenLast: "إعادة فتح آخر جلسة عند التشغيل",
  ...
  palette: {
    ...
    openSettings: "فتح إعدادات البوابة…", refreshSessions: "تحديث قائمة الجلسات", restartGateway: "إعادة تشغيل البوابة", gatewayLog: "عرض سجل البوابة",
