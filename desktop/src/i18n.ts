...
export interface Translations {
  chrome: {
    ...
    selectOrStart: string; inputPlaceholder: string; send: string; charCountTitle: string; reasoningTitle: string; reasoningAuto: string; personalityTitle: string; personalityDefault: string; fastTitle: string; fastOn: string; fastOff: string; approvalsTitle: string;
    ...
    manageProcess: string; autostart: string; autostartFailed: string; popoutFailed: string; gatewayRespawned: string; gatewayLogTitle: string; gatewayLogRefresh: string; gatewayLogClose: string; gatewayLogEmpty: string; openDirFailed: string; reopenLast: string; charWarn: string; charLimit: string; charLimitExceeded: string; notifySystem: string; completionChime: string; hideToTray: string; replayOnboarding: string; cancel: string; save: string; delete: string;
    ...
    scArchive: string; scExport: string; scFileTree: string; scQuickEntry: string; scGatewayLog: string;
    scSettings: string; scSidebar: string; scPalette: string; scFind: string; scFocus: string; scShortcuts: string; scRecall: string; scSessionNav: string; scDayJump: string; scEndHome: string; scRefreshView: string;
  };
  session: {
  ...
  kanban: {
    ...
    newBoardAction: string; newBoardPrompt: string; newBoardNamePrompt: string;
    renameBoardAction: string; renameBoardPrompt: string; removeBoardAction: string; removeBoardConfirm: string; workdirAction: string; workdirTitle: string; workdirCurrent: string; workdirNone: string; workdirUp: string; workdirClear: string; workdirUse: string; workdirFailed: string; workdirEmpty: string; promoteAction: string; promotePrompt: string; reclaimAction: string; reclaimConfirm: string; runsTitle: string; statsOldestReady: string; diagnosticsTitle: string;
  };
  projects: {
  ...
  jobs: {
    ...
    blueprintsAction: string; blueprintsTitle: string; blueprintsFilterPh: string; blueprintsEmpty: string; blueprintsFailed: string; blueprintCreate: string; suggestionsTitle: string; suggestionsAccept: string; suggestionsDismiss: string; ideasAction: string; runsHistory: string; runsHistoryTitle: string; runsEmpty: string; suggestionsScheduled: string; suggestionsSeeded: string; suggestionsSeedNone: string;
  ...
  sessionsView: {
    ...
    forkTitle: string; forked: string; forkFailed: string; openInChat: string; openInChatTitle: string;
    ...
    renameTitle: string; renamePrompt: string; renamed: string; renameFailed: string; retitleTitle: string; retitleApplied: string; retitleUnchanged: string; retitleFailed: string;
    exportHtmlTitle: string; exportJsonTitle: string;
    import: string; importTitle: string; imported: string; importParseFailed: string; importFailed: string; importPreview: string; importCancelled: string;
    msgCount: string; project: string; source: string; metaEnded: string; metaDuration: string;
    stats: string;
  ...
  modelsView: {
    ...
    colCaps: string; colPrice: string; copyModelTitle: string; copiedModel: string; copyFailed: string;
    ...
    moaTitle: string; moaEmpty: string; moaRefs: string; moaAggregator: string; moaHint: string; moaSave: string; moaSaved: string; moaFailed: string; moaBadJson: string;
  };
  pluginsView: {
  ...
  config: {
    ...
    oauthTitle: string; oauthLoggedIn: string; oauthLoggedOut: string; oauthPortal: string; oauthNote: string; oauthProviderNotConfigured: string; oauthProviderConnect: string; oauthProviderDisconnect: string; oauthProviderDisconnectConfirm: string; oauthProviderDisconnected: string; oauthProviderPending: string; oauthProviderOpen: string; oauthProviderComplete: string; oauthProviderFailed: string;
  ...
  computerUseSettingsPanel: { title: string; disabledWord: string; apply: string; clear: string; };
  secretsPanel: { title: string; order: string; noneEnabled: string; configured: string; noCommand: string; bwsMissing: string; tokenPresent: string; tokenMissing: string; opMissing: string; bindingsWord: string; tokenOptional: string; preserve: string;  syncNow: string; applyNow: string; syncing: string; applying: string; dryRunNote: string; applyNote: string; appliedLabel: string; skippedExistingLabel: string; skippedProtectedLabel: string; conflictsLabel: string; errorsLabel: string; persistedLabel: string; noneWord: string; secretsWord: string; };
  syncPanel: { title: string; device: string; unnamed: string; gate: string; gateActive: string; gateInert: string; optedIn: string; noneOptedIn: string; fetchRemote: string; fetching: string; remoteUnavailable: string; remoteEmpty: string; fromWord: string; filesWord: string;  pull: string; push: string; pulling: string; pushing: string; pulledWord: string; pushedWord: string; nothingNew: string; nothingToPush: string; };
  ...
  desktopShell: { aboutTitle: string; aboutBody: string; binaryNotFound: string; zoomChanged: string; quitGuard: string; };
  metricsPanel: { title: string; summary: string; };
  egressPanel: { title: string; };
  channelsPanel: { title: string; enabled: string; disabled: string; noneEnabled: string; test: string; stateConnected: string; stateNotConfigured: string; summary: string; summaryValue: string; homeChannel: string; knownChannels: string; recent: string;  envTitle: string; envNotSet: string; envPlaceholder: string; envReplace: string; envSet: string; envClear: string; envNote: string; };
  gatewayHealth: { title: string; ok: string; degraded: string; overall: string; stateDb: string; config: string; model: string; disk: string; gateway: string; queues: string; usedPercent: string; connectedPlatforms: string; queueCounts: string; gatewayState: string; busy: string; activeAgents: string; uptime: string; pid: string; restartLoop: string; tripped: string; calm: string; previousExit: string; exitClean: string; exitUnclean: string; exitUnknown: string; codeSkew: string; codeSkewStale: string; };
  ...
  gatewaySettingsPanel: { title: string; address: string; apiKey: string; multiplex: string; profileRoutes: string; messageTimestamps: string; loopWatchdog: string; systemdWatchdog: string; sessionCap: string; stallTimeout: string; envOverride: string; apply: string; clear: string; };
  agentSettingsPanel: { title: string; iterations: string; approvalGate: string; concurrentTools: string; contextBudget: string; verbose: string; envProbe: string; reasoning: string; serviceTier: string; personality: string; defaultWord: string; apply: string; clear: string; };
  ...
  palette: {
    ...
    openSettings: string; refreshSessions: string; restartGateway: string; gatewayLog: string; openWorkingDir: string;
    updateCheck: string; shortcuts: string; notifications: string; kanbanDispatch: string; kanbanDispatched: string; kanbanDispatchFailed: string; kanbanQuickAdd: string; kanbanQuickAddPrompt: string; kanbanQuickAdded: string; kanbanQuickAddFailed: string; kanbanBoardSwitch: string; kanbanBoardSwitched: string; kanbanBoardsFailed: string; kanbanBoardsEmpty: string; toggleSidebar: string; themePicker: string; themePickerTitle: string; themeFailed: string; fontPicker: string; fontPickerTitle: string; fontFailed: string; copySessionId: string; openSessionWindow: string; exportPickerTitle: string; copyLastReply: string; lastReplyCopied: string; lastReplyNone: string; forkSession: string; sessionForked: string; forkFailed: string; toggleHideArchived: string; newSessionInProject: string; noActiveProject: string; projectSessionCreated: string; projectsLoadFailed: string; archiveSession: string; unarchiveSession: string; sessionArchived: string; sessionUnarchived: string; sessionArchiveFailed: string; viewInSessionsBrowser: string; markAllRead: string; copyTranscript: string; copiedTranscript: string; copyTranscriptFailed: string; retitleSkills: string; retitleTitle: string; retitleNone: string; retitleRejected: string; retitleApply: string; retitleClose: string; retitleApplied: string; retitleFailed: string; unreadOnly: string; pinSession: string; unpinSession: string; sessionPinned: string; sessionUnpinned: string; retitleCurrent: string; retitledCurrent: string; retitleCurrentUnchanged: string; retitleCurrentFailed: string; fileTree: string; quickEntry: string;
...
const en: Translations = {
  chrome: {
    ...
    inputPlaceholder: "Message ulnclaw… (Enter to send, Shift+Enter for newline)", charCountTitle: "Character count", reasoningTitle: "Reasoning effort — click to pin a level (persists agent.reasoning_effort)", reasoningAuto: "auto", personalityTitle: "Personality — click to activate a persona (persists agent.personality)", personalityDefault: "default", fastTitle: "Priority Processing — click to toggle (service_tier=priority on supported models)", fastOn: "fast", fastOff: "normal", approvalsTitle: "Approval mode — click to switch (manual|smart|off; persists approvals.mode)",
    send: "Send",
    ...
    notifySystem: "System notification when a run finishes", completionChime: "Play a chime when a turn completes", hideToTray: "Hide to tray on close instead of quitting",
    delete: "Delete",
    ...
    scModelPicker: "Open the model picker", scNewSession: "New session", scCycle: "Cycle sessions", scArchive: "Archive / unarchive the current session", scExport: "Export the current session", scFileTree: "Toggle the file tree", scQuickEntry: "Open quick entry", scGatewayLog: "Open the gateway log",
    ...
    scShortcuts: "Show this dialog", scRefreshView: "Refresh the active view", scRecall: "Recall sent prompts (composer)", scSessionNav: "Navigate the session list (sidebar)", scDayJump: "Jump between day dividers (chat)", scEndHome: "Jump to newest / oldest message (chat)",
  },
  session: {
    ...
    projectBadge: "Project: {project}", endReasonTitle: "End reason: {reason}",
  ...
  slash: {
    ...
    status: "session + agent status (/status)", context: "context-window usage for this session (/context)", whoami: "process identity (/whoami)", version: "ulnclaw version (/version)", commands: "alias of /help", profile: "list configured profiles (/profile)", model: "show or persist the model (/model [provider model])", reasoning: "show or persist the reasoning effort (/reasoning [level|clear])", memory: "memory store status (/memory)", sessions: "list recent sessions (/sessions [N])", stop: "stop this session's running run (/stop)", retry: "truncate to the last user turn and re-run it (/retry)", undo: "drop the last N user turns, echoing what was removed (/undo [N])", verbose: "show or persist verbose logging (/verbose [on|off])", yolo: "auto-approve dangerous commands — approvals.mode=off (/yolo [on|off])", personality: "list or activate a personality (/personality [name|none])", goal: "standing goal — set/status/show/pause/resume/clear (/goal [text])", subgoal: "extra criteria on the active goal (/subgoal [text|remove N|clear])", reloadMcp: "rebuild the MCP tool surface (/reload-mcp [confirm])", fast: "Priority Processing toggle (/fast [on|off] [--global])", branch: "fork this session into a child branch (/branch [name])", diff: "git changes in the session cwd (/diff [working|staged|all|session] [--stat])", rollback: "list or restore filesystem checkpoints (/rollback [N|hash])", blueprint: "automation blueprints — catalog, guided setup, or direct create (/blueprint [name] [slot=val…])", cron: "manage scheduled jobs — list/show/pause/resume/run/remove/status (/cron)", suggestions: "suggested automations — list/accept/dismiss/catalog (/suggestions)", init: "generate or update AGENTS.md from a project scan (/init [notes])", agents: "active agents + recent delegations (/agents)", journey: "learning timeline — skills + memory cards (/journey)", snapshot: "state snapshots — create/list/restore/prune (/snapshot)", platforms: "messaging-platform connection posture (/platforms)", curator: "skill maintenance — status/run/pause/pin/archive (/curator)", bundles: "skill bundles — list/show; /<slug> invokes one (/bundles)", toolsets: "toolset catalog with registered toolsets marked (/toolsets)", approve: "approve a pending dangerous command (/approve [once|session|always] [run-id])", deny: "deny a pending dangerous command (/deny [run-id])", background: "run a prompt in a background tracked run (/background <prompt>)", restart: "drain active runs and exit (code 75) for the supervisor to restart (/restart)", queue: "queue a prompt for the next turn without interrupting (/queue <prompt>)", steer: "inject a message after the next tool call without interrupting (/steer <prompt>)", approvals: "show or persist the dangerous-command approval mode (/approvals [manual|smart|off])", debug: "write a redacted debug bundle under <home>/debug-bundles (/debug [no-redact])", image: "attach a local image to your next prompt (/image <path>)",
    ...
    platform: "gateway platform retry controls (list/pause/resume)",
  },
  busy: {
    titlePlain: "Busy behavior",
    title: "Busy behavior: {mode} — click to change",
    queue: "queue for the next turn",
    steer: "steer into the active turn",
    interrupt: "interrupt, then send",
    queued: "queued for the next turn ({count} waiting)",
    steerSent: "steered into the active turn",
    interruptQueued: "stop requested — message queued ({count} waiting)",
    modeChanged: "busy behavior: {mode}",
  },
  quickEntry: { placeholder: "Ask anything…", disconnected: "Gateway disconnected", hint: "Enter to send · Esc to close", reconnectHint: "Reconnecting to the gateway…", targetCurrent: "This session", targetNew: "New session" },
  ...
  bridge: {
    ...
    sessionCreated: "New session from another client", sessionDeleted: "Session deleted by another client",
  },
  kanban: {
    ...
    newTaskTitle: "New task", newTaskTitleField: "Title", newTaskBody: "Description", createAction: "Create", newBoardAction: "New board", newBoardPrompt: "New board slug (lowercase letters, digits, dashes):", newBoardNamePrompt: "Board display name (optional):", renameBoardAction: "Rename board", renameBoardPrompt: "New display name for this board:", removeBoardAction: "Remove board", removeBoardConfirm: "Remove board {board}? Archived tasks stay in the database; the board itself is deleted.", workdirAction: "Set board workdir", workdirTitle: "Board workdir", workdirCurrent: "Current workdir: {path}", workdirNone: "No workdir set yet — tasks fall back to the gateway default cwd.", workdirUp: "Up", workdirClear: "Clear", workdirUse: "Use this directory", workdirFailed: "Browse failed: {error}", workdirEmpty: "No subdirectories here.", promoteAction: "Promote", promotePrompt: "Reason to promote this task to ready (optional):", reclaimAction: "Reclaim", reclaimConfirm: "Reclaim this running task? The active worker claim is released and the task returns to ready.", runsTitle: "Run history", statsOldestReady: "oldest ready {age}", diagnosticsTitle: "Diagnostics", 
  },
  projects: {
  ...
  jobs: {
    ...
    blueprintsAction: "Templates", blueprintsTitle: "Automation templates", blueprintsFilterPh: "Filter templates…", blueprintsEmpty: "No templates match your filter.", blueprintsFailed: "Template load failed: {error}", blueprintCreate: "Create job", suggestionsTitle: "Suggested automations", suggestionsAccept: "Accept", suggestionsDismiss: "Dismiss", ideasAction: "Ideas", runsHistory: "Run history", runsHistoryTitle: "Run history — {name}", runsEmpty: "No runs recorded for this job yet.", suggestionsScheduled: "Scheduled '{name}' ({schedule}). Manage it in the jobs list.", suggestionsSeeded: "Added {count} starter automation idea(s). Review them here.", suggestionsSeedNone: "No new starter automations to add (already offered or dismissed).",
  ...
  sessionsView: {
    ...
    exportTitle: "Export selected session as Markdown", exportHtmlTitle: "Export selected session as standalone HTML", exportJsonTitle: "Export selected session as portable JSON (re-importable)", import: "⭱ Import", importTitle: "Import sessions from a portable JSON export", imported: "Imported {imported} session(s), {messages} message(s); skipped {skipped}.", importPreview: "Import this file? {imported} new session(s) with {messages} message(s); {skipped} already present.", importCancelled: "Import cancelled.", importParseFailed: "Import failed: file is not a session export JSON payload.", importFailed: "Import failed: {error}", msgCount: "{count} messages", project: "project", source: "source", metaEnded: "ended", metaDuration: "duration", stats: "{sessions} sessions \u00b7 {messages} messages \u00b7 {size} on disk",
    ...
    forkTitle: "Fork this session into a new branch", forked: "Forked as {id}", forkFailed: "Fork failed: {error}", openInChat: "→ Chat", openInChatTitle: "Open this session in the chat view",
    ...
    renameTitle: "Rename this session", retitleTitle: "Regenerate title via LLM", retitleApplied: "Title regenerated: {label}", retitleUnchanged: "Title already up to date.", retitleFailed: "Title regeneration failed (provider unreachable or rejected).", renamePrompt: "New title (empty clears):", renamed: "Session renamed.", renameFailed: "Rename failed: {error}",
  },
  modelsView: {
  ...
  computerUsePanel: { title: "Computer Use", driver: "Driver", notInstalled: "not installed", telemetry: "Telemetry", maxDimension: "Max image dimension", captureAfter: "Capture after", overlay: "Overlay", overlayAuto: "auto", overlayOn: "force-on", overlayOff: "force-off", runDoctor: "Run doctor", running: "Running\u2026", overall: "Overall" },
    computerUseSettingsPanel: { title: "Computer Use settings", disabledWord: "disabled", apply: "Apply", clear: "Clear" },
  secretsPanel: { title: "Secret sources", order: "Source order", noneEnabled: "no sources enabled", configured: "configured", noCommand: "no command set", bwsMissing: "bws NOT FOUND", tokenPresent: "token present", tokenMissing: "token MISSING", opMissing: "op NOT FOUND", bindingsWord: "bindings", tokenOptional: "no service token (interactive auth may work)", preserve: "Preserve existing" , syncNow: "Sync now", applyNow: "Apply to .env", syncing: "Syncing…", applying: "Applying…", dryRunNote: "Dry run — nothing was written. Apply persists the winners to .env.", applyNote: "Persisted to .env — values load at the next gateway start.", appliedLabel: "Applied", skippedExistingLabel: "Skipped (already set)", skippedProtectedLabel: "Skipped (protected)", conflictsLabel: "Conflicts", errorsLabel: "Errors", persistedLabel: "Persisted", noneWord: "none", secretsWord: "secrets" },
  syncPanel: { title: "Skills sync", device: "Device", unnamed: "unnamed", gate: "Gate", gateActive: "active", gateInert: "inert", optedIn: "Opted-in", noneOptedIn: "none (ulnclaw sync enable <skill>)", fetchRemote: "Fetch remote", fetching: "Fetching\u2026", remoteUnavailable: "Remote manifest unavailable", remoteEmpty: "Remote manifest is empty.", fromWord: "from", filesWord: "file(s)" , pull: "Pull now", push: "Push now", pulling: "Pulling…", pushing: "Pushing…", pulledWord: "Pulled", pushedWord: "Pushed", nothingNew: "Nothing new to pull.", nothingToPush: "Nothing to push." },
  ...
  desktopShell: { aboutTitle: "About ulnclaw", aboutBody: "Desktop shell v{version} · gateway port {port} · binary: {binary}", binaryNotFound: "not found", zoomChanged: "Zoom: {percent}%", quitGuard: "A turn is still running — quitting now will interrupt it. Quit anyway?" },
  metricsPanel: { title: "Prometheus metrics", summary: "Show raw /metrics exposition" },
  egressPanel: { title: "Egress proxy" },
  channelsPanel: { title: "Messaging channels", enabled: "Enabled", disabled: "Disabled", noneEnabled: "(none)", test: "Test", stateConnected: "connected", stateNotConfigured: "not configured", summary: "Connected", summaryValue: "{connected}/{enabled} connected", homeChannel: "home", knownChannels: "{count} known", recent: "Recently active" , envTitle: "env keys", envNotSet: "not set", envPlaceholder: "new value", envReplace: "replace value", envSet: "Set", envClear: "Clear", envNote: "Values are write-only (GET returns redacted previews); restart the gateway to apply." },
  gatewayHealth: { title: "Gateway health", ok: "ok", degraded: "degraded", overall: "Overall", stateDb: "Session store", config: "Config", model: "Model", disk: "Disk", gateway: "Platforms", queues: "Background queues", usedPercent: "{pct}% used", connectedPlatforms: "{connected}/{total} connected", queueCounts: "{runs} active \u00b7 {queued} queued", gatewayState: "Gateway state", busy: "busy", activeAgents: "Active turns", uptime: "Uptime", pid: "PID", restartLoop: "Restart-loop breaker", tripped: "TRIPPED", calm: "calm", previousExit: "Previous exit", exitClean: "clean", exitUnclean: "unclean", exitUnknown: "unknown", codeSkew: "Code skew", codeSkewStale: "STALE" },
  ...
  gatewaySettingsPanel: { title: "Gateway settings", address: "Listener", apiKey: "API key", multiplex: "Profile multiplexing", profileRoutes: "Profile routes", messageTimestamps: "Message timestamps", loopWatchdog: "Loop watchdog", systemdWatchdog: "systemd watchdog", sessionCap: "Session cap", stallTimeout: "Stall timeout", envOverride: "env override", apply: "Apply", clear: "Clear" },
  agentSettingsPanel: { title: "Agent settings", iterations: "Iteration budget", approvalGate: "Approval gate", concurrentTools: "Concurrent tools", contextBudget: "Context budget", verbose: "Verbose logging", envProbe: "Environment probe", reasoning: "Reasoning effort", serviceTier: "Service tier", personality: "Personality", defaultWord: "default", apply: "Apply", clear: "Clear" },
  ...
  palette: {
    ...
    openSettings: "Open gateway settings…", refreshSessions: "Refresh session list", restartGateway: "Restart gateway", gatewayLog: "Show gateway log", openWorkingDir: "Open working directory in file manager",
    updateCheck: "Check for updates", shortcuts: "Keyboard shortcuts", notifications: "Notification history", kanbanDispatch: "Dispatch kanban tasks", kanbanDispatched: "Kanban dispatch: {spawned} spawned · {promoted} promoted · {reclaimed} reclaimed", kanbanDispatchFailed: "Kanban dispatch failed: {error}", kanbanQuickAdd: "New kanban task…", kanbanQuickAddPrompt: "Task title:", kanbanQuickAdded: "Kanban task created: {id} — {title}", kanbanQuickAddFailed: "Kanban task creation failed: {error}", kanbanBoardSwitch: "Switch kanban board…", kanbanBoardSwitched: "Kanban board switched: {board}", kanbanBoardsFailed: "Kanban boards load failed: {error}", kanbanBoardsEmpty: "No kanban boards available", toggleSidebar: "Toggle sidebar", themePicker: "Switch theme…", themePickerTitle: "Dashboard theme", themeFailed: "Theme load failed: {error}", fontPicker: "Switch font…", fontPickerTitle: "Dashboard font", fontFailed: "Font load failed: {error}", copySessionId: "Copy session ID", openSessionWindow: "Open session in new window", exportPickerTitle: "Export session as…", copyLastReply: "Copy last assistant reply", lastReplyCopied: "Last assistant reply copied.", lastReplyNone: "No assistant reply to copy yet.", forkSession: "Fork current session", sessionForked: "Session forked: {label}", forkFailed: "Session fork failed: {error}", toggleHideArchived: "Toggle hide-archived sessions", newSessionInProject: "New session in active project", noActiveProject: "No active project — set one in the Projects view.", projectSessionCreated: "Session started in project: {label}", projectsLoadFailed: "Projects load failed: {error}", archiveSession: "Archive current session", unarchiveSession: "Restore current session (unarchive)", sessionArchived: "Session archived: {label}", sessionUnarchived: "Session restored: {label}", sessionArchiveFailed: "Session archive failed: {error}", viewInSessionsBrowser: "View current session in sessions browser", markAllRead: "Mark all sessions read", copyTranscript: "Copy transcript as Markdown", copiedTranscript: "Transcript copied to clipboard", copyTranscriptFailed: "Copy transcript failed: {error}", retitleSkills: "Retitle leaked /skill session titles…", retitleTitle: "Retitle /skill sessions — {count} scanned", retitleNone: "No leaked /skill titles found.", retitleRejected: "rejected", retitleApply: "Apply new titles", retitleClose: "Close", retitleApplied: "Applied {count} new title(s)", retitleFailed: "Retitle failed: {error}", unreadOnly: "Show only unread sessions (toggle)", pinSession: "Pin current session to top", unpinSession: "Unpin current session", sessionPinned: "Pinned {label} to the top", sessionUnpinned: "Unpinned {label}", retitleCurrent: "Regenerate session title via LLM", retitledCurrent: "Title regenerated: {label}", retitleCurrentUnchanged: "Title already up to date.", retitleCurrentFailed: "Title regeneration failed (provider unreachable or rejected).", fileTree: "Toggle file tree", quickEntry: "Quick entry…",
...
const zh: Translations = {
  chrome: {
    ...
    inputPlaceholder: "给 ulnclaw 发消息…（Enter 发送，Shift+Enter 换行）", charCountTitle: "字符数", reasoningTitle: "推理深度 —— 点击钉选级别（持久化 agent.reasoning_effort）", reasoningAuto: "自动", personalityTitle: "人格 —— 点击启用人格（持久化 agent.personality）", personalityDefault: "默认", fastTitle: "优先处理 —— 点击切换（受支持的模型发送 service_tier=priority）", fastOn: "快速", fastOff: "普通", approvalsTitle: "审批模式 —— 点击切换（manual|smart|off；持久化 approvals.mode）",
    send: "发送",
    micTitle: "语音输入（录音并转写）",
    ...
    manageProcess: "管理网关进程（随应用启动/停止）", autostart: "登录时启动 ulnclaw", autostartFailed: "无法更改登录时启动设置。", popoutFailed: "无法打开会话窗口：{error}", gatewayRespawned: "网关已崩溃——已自动重新拉起。", gatewayLogTitle: "网关日志", gatewayLogRefresh: "刷新", gatewayLogClose: "关闭", gatewayLogEmpty: "尚未捕获到网关输出。", openDirFailed: "无法打开目录：{error}", reopenLast: "启动时重新打开上次会话",
    charWarn: "输入框预警阈值（字符数）",
    charLimit: "输入框硬性上限（字符数，0 = 关闭）",
    charLimitExceeded: "消息过长（{length}/{limit} 字符）——请精简后再发送",
    notifySystem: "运行结束时弹出系统通知", completionChime: "回合完成时播放提示音", hideToTray: "关闭时隐藏到托盘而不是退出",
    delete: "删除",
    ...
    scModelPicker: "打开模型挑选器", scNewSession: "新建会话", scCycle: "循环切换会话", scArchive: "归档/恢复当前会话", scExport: "导出当前会话", scFileTree: "切换文件树", scQuickEntry: "打开快速输入", scGatewayLog: "打开网关日志",
    scSessionPicker: "打开会话挑选器", scSettings: "打开设置", scSidebar: "切换侧栏",
    scPalette: "命令面板", scFind: "聊天内查找", scFocus: "聚焦输入框",
    scShortcuts: "显示本对话框", scRefreshView: "刷新当前视图", scRecall: "回调已发送提示词（输入框）", scSessionNav: "键盘浏览会话列表（侧栏）", scDayJump: "在日期分隔线间跳转（聊天）", scEndHome: "跳到最新 / 最早消息（聊天）",
  },
  session: {
    ...
    projectBadge: "项目：{project}", endReasonTitle: "结束原因：{reason}",
  ...
  slash: {
    ...
    status: "会话与 agent 状态（/status）", context: "本会话上下文窗口用量（/context）", whoami: "进程身份（/whoami）", version: "ulnclaw 版本（/version）", commands: "/help 的别名", profile: "列出已配置的 profile（/profile）", model: "查看或持久化模型（/model [provider model]）", reasoning: "查看或持久化推理深度（/reasoning [level|clear]）", memory: "记忆库状态（/memory）", sessions: "列出最近会话（/sessions [N]）", stop: "停止本会话运行中的 run（/stop）", retry: "截断到最近一次用户提问并重新执行（/retry）", undo: "撤销最近 N 轮用户提问并回显被删内容（/undo [N]）", verbose: "查看或持久化详细日志（/verbose [on|off]）", yolo: "自动批准危险命令——approvals.mode=off（/yolo [on|off]）", personality: "列出或启用人格（/personality [name|none]）", goal: "常设目标——设置/状态/查看/暂停/恢复/清除（/goal [文本]）", subgoal: "为当前目标追加验收条件（/subgoal [文本|remove N|clear]）", reloadMcp: "重建 MCP 工具面（/reload-mcp [confirm]）", fast: "优先处理开关（/fast [on|off] [--global]）", branch: "把当前会话分叉为子分支（/branch [名称]）", diff: "会话 cwd 的 git 变更（/diff [working|staged|all|session] [--stat]）", rollback: "列出/恢复文件系统检查点（/rollback [N|hash]）", blueprint: "自动化蓝图——浏览目录、引导式配置或直接创建（/blueprint [名称] [槽位=值…]）", cron: "管理定时任务——列出/查看/暂停/恢复/运行/删除/状态（/cron）", suggestions: "建议的自动化——列出/接受/拒绝/目录（/suggestions）", init: "从项目扫描生成或更新 AGENTS.md（/init [备注]）", agents: "活动 agent 与最近的委派任务（/agents）", journey: "学习时间线——已学技能与记忆卡片（/journey）", snapshot: "状态快照——创建/列出/恢复/清理（/snapshot）", platforms: "消息平台连接状态（/platforms）", curator: "技能维护——状态/运行/暂停/固定/归档（/curator）", bundles: "技能捆绑包——列出/查看；/<slug> 直接调用（/bundles）", toolsets: "工具集目录，标记已注册的工具集（/toolsets）", approve: "批准待审的危险命令（/approve [once|session|always] [run-id]）", deny: "拒绝待审的危险命令（/deny [run-id]）", background: "在后台受跟踪 run 中执行提示词（/background <提示词>）", restart: "排空活动运行并退出（码 75），由监督者重启（/restart）", queue: "排队一条提示词留待下一轮执行，不打断当前回合（/queue <提示词>）", steer: "在下一次工具调用后注入消息，不打断当前回合（/steer <提示词>）", approvals: "查看或持久化危险命令审批模式（/approvals [manual|smart|off]）", debug: "在 <home>/debug-bundles 下写入脱敏调试包（/debug [no-redact]）", image: "为下一条提示附加本地图片（/image <路径>）",
    resume: "恢复近期会话（桌面）",
    ...
    platform: "网关平台重试控制（list/pause/resume）",
  },
  busy: {
    titlePlain: "忙碌时行为",
    title: "忙碌时行为：{mode}——点击切换",
    queue: "排队到下一回合",
    steer: "注入当前回合",
    interrupt: "先打断再发送",
    queued: "已排队到下一回合（{count} 条等待）",
    steerSent: "已注入当前活动回合",
    interruptQueued: "已请求停止——消息已排队（{count} 条等待）",
    modeChanged: "忙碌时行为：{mode}",
  },
  quickEntry: { placeholder: "随便问点什么…", disconnected: "网关已断开", hint: "Enter 发送 · Esc 关闭", reconnectHint: "正在重新连接网关…", targetCurrent: "当前会话", targetNew: "新建会话" },
  ...
  bridge: {
    ...
    sessionCreated: "其他客户端新建了会话", sessionDeleted: "其他客户端删除了会话",
  },
  kanban: {
    ...
    newTaskTitle: "新建任务", newTaskTitleField: "标题", newTaskBody: "描述", createAction: "创建", newBoardAction: "新建看板", newBoardPrompt: "新看板 slug（小写字母、数字、连字符）：", newBoardNamePrompt: "看板显示名（可选）：", renameBoardAction: "重命名看板", renameBoardPrompt: "该看板的新显示名：", removeBoardAction: "删除看板", removeBoardConfirm: "删除看板 {board}？已归档任务仍保留在数据库中，看板本身将被删除。", workdirAction: "设置看板工作目录", workdirTitle: "看板工作目录", workdirCurrent: "当前工作目录：{path}", workdirNone: "尚未设置工作目录——任务将回退到网关默认 cwd。", workdirUp: "上级", workdirClear: "清除", workdirUse: "使用此目录", workdirFailed: "浏览失败：{error}", workdirEmpty: "此处没有子目录。", promoteAction: "晋升", promotePrompt: "将该任务晋升为就绪的原因（可选）：", reclaimAction: "回收", reclaimConfirm: "回收该运行中的任务？活动的工作者认领将被释放，任务回到就绪状态。", runsTitle: "运行历史", statsOldestReady: "最旧就绪 {age}", diagnosticsTitle: "诊断", 
  },
  projects: {
  ...
  jobs: {
    ...
    blueprintsAction: "模板", blueprintsTitle: "自动化模板", blueprintsFilterPh: "筛选模板…", blueprintsEmpty: "没有匹配筛选条件的模板。", blueprintsFailed: "模板加载失败：{error}", blueprintCreate: "创建任务", suggestionsTitle: "建议的自动化", suggestionsAccept: "接受", suggestionsDismiss: "忽略", ideasAction: "点子", runsHistory: "运行历史", runsHistoryTitle: "运行历史——{name}", runsEmpty: "该任务还没有运行记录。", suggestionsScheduled: "已创建定时任务“{name}”（{schedule}），可在任务列表中管理。", suggestionsSeeded: "已添加 {count} 个入门自动化建议，请在此审阅。", suggestionsSeedNone: "没有新的入门自动化可添加（已全部推荐或忽略过）。",
  ...
  sessionsView: {
    ...
    exportTitle: "将选中会话导出为 Markdown", exportHtmlTitle: "将选中会话导出为独立 HTML", exportJsonTitle: "将选中会话导出为可移植 JSON（可重新导入）", import: "⭱ 导入", importTitle: "从可移植 JSON 导出文件导入会话", imported: "已导入 {imported} 个会话、{messages} 条消息；跳过 {skipped}。", importPreview: "导入此文件？将新增 {imported} 个会话（{messages} 条消息），{skipped} 个已存在。", importCancelled: "已取消导入。", importParseFailed: "导入失败：文件不是会话导出 JSON 载荷。", importFailed: "导入失败：{error}", msgCount: "{count} 条消息", project: "项目", source: "来源", metaEnded: "已结束", metaDuration: "时长", stats: "{sessions} 个会话 \u00b7 {messages} 条消息 \u00b7 磁盘占用 {size}",
    ...
    forkTitle: "将此会话分叉为新分支", forked: "已分叉为 {id}", forkFailed: "分叉失败:{error}", openInChat: "→ 聊天", openInChatTitle: "在聊天视图中打开此会话",
    ...
    renameTitle: "重命名此会话", retitleTitle: "经 LLM 重新生成标题", retitleApplied: "已重新生成标题：{label}", retitleUnchanged: "标题已是最新。", retitleFailed: "标题重新生成失败（provider 不可达或被拒绝）。", renamePrompt: "新标题（留空清除）：", renamed: "会话已重命名。", renameFailed: "重命名失败:{error}",
  },
  modelsView: {
  ...
  computerUsePanel: { title: "Computer Use（电脑操作）", driver: "驱动", notInstalled: "未安装", telemetry: "遥测", maxDimension: "最大图像边长", captureAfter: "截图时机", overlay: "覆盖层", overlayAuto: "自动", overlayOn: "强制开", overlayOff: "强制关", runDoctor: "运行体检", running: "运行中…", overall: "总体" },
    computerUseSettingsPanel: { title: "Computer Use 设置", disabledWord: "已禁用", apply: "应用", clear: "清除" },
  secretsPanel: { title: "密钥源", order: "源顺序", noneEnabled: "未启用任何源", configured: "已配置", noCommand: "未设置命令", bwsMissing: "未找到 bws", tokenPresent: "令牌存在", tokenMissing: "令牌缺失", opMissing: "未找到 op", bindingsWord: "条绑定", tokenOptional: "无服务令牌（交互式认证仍可用）", preserve: "保留已有" , syncNow: "立即同步", applyNow: "写入 .env", syncing: "同步中…", applying: "写入中…", dryRunNote: "试运行——未写入任何内容。应用可将胜出值持久化到 .env。", applyNote: "已持久化到 .env——值将在网关下次启动时加载。", appliedLabel: "已应用", skippedExistingLabel: "已跳过（已有值）", skippedProtectedLabel: "已跳过（受保护）", conflictsLabel: "冲突", errorsLabel: "错误", persistedLabel: "已持久化", noneWord: "无", secretsWord: "个密钥" },
  syncPanel: { title: "技能同步", device: "设备", unnamed: "未命名", gate: "闸门", gateActive: "活跃", gateInert: "未启用", optedIn: "已加入", noneOptedIn: "无（ulnclaw sync enable <skill>）", fetchRemote: "拉取远端", fetching: "拉取中…", remoteUnavailable: "远端清单不可用", remoteEmpty: "远端清单为空。", fromWord: "来自", filesWord: "个文件" , pull: "立即拉取", push: "立即推送", pulling: "拉取中…", pushing: "推送中…", pulledWord: "已拉取", pushedWord: "已推送", nothingNew: "没有新内容可拉取。", nothingToPush: "没有可推送的内容。" },
  ...
  desktopShell: { aboutTitle: "关于 ulnclaw", aboutBody: "桌面外壳 v{version} · 网关端口 {port} · 二进制：{binary}", binaryNotFound: "未找到", zoomChanged: "缩放：{percent}%", quitGuard: "仍有回合在运行——现在退出将中断它。仍要退出吗？" },
  metricsPanel: { title: "Prometheus 指标", summary: "显示 /metrics 原始输出" },
  egressPanel: { title: "出站代理" },
  channelsPanel: { title: "消息通道", enabled: "已启用", disabled: "未启用", noneEnabled: "（无）", test: "测试", stateConnected: "已连接", stateNotConfigured: "未配置", summary: "连接状况", summaryValue: "已连接 {connected}/{enabled}", homeChannel: "主频道", knownChannels: "已知 {count} 个", recent: "最近活跃" , envTitle: "环境变量", envNotSet: "未设置", envPlaceholder: "新值", envReplace: "替换值", envSet: "设置", envClear: "清除", envNote: "值只写不读（GET 仅返回打码预览）；重启网关后生效。" },
  gatewayHealth: { title: "网关健康", ok: "正常", degraded: "降级", overall: "总体状态", stateDb: "会话存储", config: "配置", model: "模型", disk: "磁盘", gateway: "平台", queues: "后台队列", usedPercent: "已用 {pct}%", connectedPlatforms: "已连接 {connected}/{total}", queueCounts: "活动 {runs} \u00b7 排队 {queued}", gatewayState: "网关状态", busy: "忙碌", activeAgents: "活动回合", uptime: "运行时长", pid: "PID", restartLoop: "重启循环断路器", tripped: "已触发", calm: "平静", previousExit: "上次退出", exitClean: "干净", exitUnclean: "非正常", exitUnknown: "未知", codeSkew: "代码偏差", codeSkewStale: "已过时" },
  ...
  gatewaySettingsPanel: { title: "网关设置", address: "监听地址", apiKey: "API 密钥", multiplex: "多 profile 复用", profileRoutes: "profile 路由数", messageTimestamps: "消息时间戳", loopWatchdog: "运行时看门狗", systemdWatchdog: "systemd 看门狗", sessionCap: "会话上限", stallTimeout: "停滞超时", envOverride: "环境变量覆盖", apply: "应用", clear: "清除" },
  agentSettingsPanel: { title: "代理设置", iterations: "迭代预算", approvalGate: "审批开关", concurrentTools: "并发工具", contextBudget: "上下文预算", verbose: "详细日志", envProbe: "环境探测", reasoning: "推理强度", serviceTier: "服务等级", personality: "人格", defaultWord: "默认", apply: "应用", clear: "清除" },
  ...
  palette: {
    ...
    openSettings: "打开网关设置…", refreshSessions: "刷新会话列表", restartGateway: "重启网关", gatewayLog: "查看网关日志", openWorkingDir: "在文件管理器中打开工作目录",
    updateCheck: "检查更新", shortcuts: "键盘快捷键", notifications: "通知历史", kanbanDispatch: "派发看板任务", kanbanDispatched: "看板派发：{spawned} 派生 · {promoted} 晋升 · {reclaimed} 回收", kanbanDispatchFailed: "看板派发失败：{error}", kanbanQuickAdd: "新建看板任务…", kanbanQuickAddPrompt: "任务标题：", kanbanQuickAdded: "已创建看板任务：{id} —— {title}", kanbanQuickAddFailed: "看板任务创建失败：{error}", kanbanBoardSwitch: "切换看板…", kanbanBoardSwitched: "已切换看板：{board}", kanbanBoardsFailed: "看板列表加载失败：{error}", kanbanBoardsEmpty: "暂无可用看板", toggleSidebar: "切换侧栏", themePicker: "切换主题…", themePickerTitle: "仪表盘主题", themeFailed: "主题加载失败：{error}", fontPicker: "切换字体…", fontPickerTitle: "仪表盘字体", fontFailed: "字体加载失败：{error}", copySessionId: "复制会话 ID", openSessionWindow: "在新窗口打开会话", exportPickerTitle: "将会话导出为…", copyLastReply: "复制最后一条助手回复", lastReplyCopied: "已复制最后一条助手回复。", lastReplyNone: "还没有可复制的助手回复。", forkSession: "分叉当前会话", sessionForked: "已分叉会话：{label}", forkFailed: "会话分叉失败：{error}", toggleHideArchived: "切换隐藏已归档会话", newSessionInProject: "在活动项目中新建会话", noActiveProject: "暂无活动项目——请先在项目视图设置。", projectSessionCreated: "已在项目中启动会话：{label}", projectsLoadFailed: "项目列表加载失败：{error}", archiveSession: "归档当前会话", unarchiveSession: "恢复当前会话（取消归档）", sessionArchived: "已归档会话：{label}", sessionUnarchived: "已恢复会话：{label}", sessionArchiveFailed: "会话归档失败：{error}", viewInSessionsBrowser: "在会话浏览器中查看当前会话", markAllRead: "将所有会话标为已读", copyTranscript: "复制会话转录为 Markdown", copiedTranscript: "转录已复制到剪贴板", copyTranscriptFailed: "复制转录失败：{error}", retitleSkills: "修复泄漏的 /skill 会话标题…", retitleTitle: "重命名 /skill 会话——已扫描 {count} 个", retitleNone: "未发现泄漏的 /skill 标题。", retitleRejected: "已拒绝", retitleApply: "应用新标题", retitleClose: "关闭", retitleApplied: "已应用 {count} 个新标题", retitleFailed: "重命名失败：{error}", unreadOnly: "仅显示未读会话（切换）", pinSession: "置顶当前会话", unpinSession: "取消置顶当前会话", sessionPinned: "已置顶 {label}", sessionUnpinned: "已取消置顶 {label}", retitleCurrent: "经 LLM 重新生成会话标题", retitledCurrent: "已重新生成标题：{label}", retitleCurrentUnchanged: "标题已是最新。", retitleCurrentFailed: "标题重新生成失败（provider 不可达或被拒绝）。", fileTree: "切换文件树", quickEntry: "快速输入…",
...
const zhHant: Translations = {
  chrome: {
    ...
    inputPlaceholder: "傳送訊息給 ulnclaw…（Enter 傳送，Shift+Enter 換行）", charCountTitle: "字元數", reasoningTitle: "推理深度 —— 點選釘選層級（持久化 agent.reasoning_effort）", reasoningAuto: "自動", personalityTitle: "人格 —— 點選啟用人格（持久化 agent.personality）", personalityDefault: "預設", fastTitle: "優先處理 —— 點選切換（受支援的模型傳送 service_tier=priority）", fastOn: "快速", fastOff: "普通", approvalsTitle: "核准模式 —— 點選切換（manual|smart|off；持久化 approvals.mode）",
    send: "傳送",
    micTitle: "語音輸入（錄音並轉寫）",
    ...
    manageProcess: "管理閘道程序（隨應用程式啟動/停止）", autostart: "登入時啟動 ulnclaw", autostartFailed: "無法變更登入時啟動設定。", popoutFailed: "無法開啟工作階段視窗：{error}", gatewayRespawned: "閘道已當機——已自動重新啟動。", gatewayLogTitle: "閘道日誌", gatewayLogRefresh: "重新整理", gatewayLogClose: "關閉", gatewayLogEmpty: "尚未擷取到閘道輸出。", openDirFailed: "無法開啟目錄：{error}", reopenLast: "啟動時重新開啟上次工作階段",
    charWarn: "輸入框預警閾值（字元數）",
    charLimit: "輸入框硬性上限（字元數，0 = 關閉）",
    charLimitExceeded: "訊息過長（{length}/{limit} 字元）——請精簡後再傳送",
    notifySystem: "執行結束時彈出系統通知", completionChime: "回合完成時播放提示音", hideToTray: "關閉時隱藏到系統匣而不是結束",
    delete: "刪除",
    ...
    scModelPicker: "開啟模型挑選器", scNewSession: "新增工作階段", scCycle: "循環切換工作階段", scArchive: "歸檔/恢復目前工作階段", scExport: "匯出目前工作階段", scFileTree: "切換檔案樹", scQuickEntry: "開啟快速輸入", scGatewayLog: "開啟閘道日誌",
    scSessionPicker: "開啟工作階段挑選器", scSettings: "開啟設定", scSidebar: "切換側欄",
    scPalette: "命令面板", scFind: "聊天內尋找", scFocus: "聚焦輸入框",
    scShortcuts: "顯示本對話框", scRefreshView: "重新整理目前視圖", scRecall: "回撥已傳送提示詞（輸入框）", scSessionNav: "鍵盤瀏覽工作階段清單（側欄）", scDayJump: "在日期分隔線間跳轉（聊天）", scEndHome: "跳到最新 / 最早訊息（聊天）",
  },
  session: {
    ...
    projectBadge: "專案：{project}", endReasonTitle: "結束原因：{reason}",
  ...
  slash: {
    ...
    status: "工作階段與 agent 狀態（/status）", context: "本工作階段上下文視窗用量（/context）", whoami: "處理序身分（/whoami）", version: "ulnclaw 版本（/version）", commands: "/help 的別名", profile: "列出已設定的 profile（/profile）", model: "檢視或持久化模型（/model [provider model]）", reasoning: "檢視或持久化推理深度（/reasoning [level|clear]）", memory: "記憶庫狀態（/memory）", sessions: "列出最近工作階段（/sessions [N]）", stop: "停止本工作階段執行中的 run（/stop）", retry: "截斷到最近一次使用者提問並重新執行（/retry）", undo: "撤銷最近 N 輪使用者提問並回顯被刪內容（/undo [N]）", verbose: "檢視或持久化詳細日誌（/verbose [on|off]）", yolo: "自動批准危險命令——approvals.mode=off（/yolo [on|off]）", personality: "列出或啟用人格（/personality [name|none]）", goal: "常設目標——設定/狀態/檢視/暫停/恢復/清除（/goal [文字]）", subgoal: "為目前目標追加驗收條件（/subgoal [文字|remove N|clear]）", reloadMcp: "重建 MCP 工具面（/reload-mcp [confirm]）", fast: "優先處理開關（/fast [on|off] [--global]）", branch: "把目前會話分叉為子分支（/branch [名稱]）", diff: "會話 cwd 的 git 變更（/diff [working|staged|all|session] [--stat]）", rollback: "列出/還原檔案系統檢查點（/rollback [N|hash]）", blueprint: "自動化藍圖——瀏覽目錄、引導式設定或直接建立（/blueprint [名稱] [欄位=值…]）", cron: "管理排程任務——列出/檢視/暫停/恢復/執行/刪除/狀態（/cron）", suggestions: "建議的自動化——列出/接受/拒絕/目錄（/suggestions）", init: "從專案掃描產生或更新 AGENTS.md（/init [備註]）", agents: "活動 agent 與最近的委派任務（/agents）", journey: "學習時間軸——已學技能與記憶卡片（/journey）", snapshot: "狀態快照——建立/列出/還原/清理（/snapshot）", platforms: "訊息平台連線狀態（/platforms）", curator: "技能維護——狀態/執行/暫停/釘選/封存（/curator）", bundles: "技能組合包——列出/檢視；/<slug> 直接呼叫（/bundles）", toolsets: "工具集目錄，標記已註冊的工具集（/toolsets）", approve: "核准待審的危險命令（/approve [once|session|always] [run-id]）", deny: "拒絕待審的危險命令（/deny [run-id]）", background: "在後台受追蹤 run 中執行提示詞（/background <提示詞>）", restart: "排空活動執行並結束（碼 75），由監督者重啟（/restart）", queue: "排隊一條提示詞留待下一輪執行，不打斷目前回合（/queue <提示詞>）", steer: "在下一次工具呼叫後注入訊息，不打斷目前回合（/steer <提示詞>）", approvals: "檢視或持久化危險命令審批模式（/approvals [manual|smart|off]）", debug: "在 <home>/debug-bundles 下寫入去識感除個資料的除錯包（/debug [no-redact]）", image: "為下一條提示附加本地圖片（/image <路徑>）",
    resume: "恢復近期工作階段（桌面）",
    ...
    platform: "閘道平台重試控制（list/pause/resume）",
  },
  busy: {
    titlePlain: "忙碌時行為",
    title: "忙碌時行為：{mode}——點選切換",
    queue: "排隊到下一回合",
    steer: "注入目前回合",
    interrupt: "先中斷再傳送",
    queued: "已排隊到下一回合（{count} 條等待）",
    steerSent: "已注入目前活動回合",
    interruptQueued: "已請求停止——訊息已排隊（{count} 條等待）",
    modeChanged: "忙碌時行為：{mode}",
  },
  quickEntry: { placeholder: "隨便問點什麼…", disconnected: "閘道已斷線", hint: "Enter 傳送 · Esc 關閉", reconnectHint: "正在重新連線閘道…", targetCurrent: "目前工作階段", targetNew: "新增工作階段" },
  ...
  bridge: {
    ...
    sessionCreated: "其他用戶端建立了工作階段", sessionDeleted: "其他用戶端刪除了工作階段",
  },
  kanban: {
    ...
    newTaskTitle: "新建工作", newTaskTitleField: "標題", newTaskBody: "描述", createAction: "建立", newBoardAction: "新建看板", newBoardPrompt: "新看板 slug（小寫字母、數字、連字號）：", newBoardNamePrompt: "看板顯示名（選填）：", renameBoardAction: "重新命名看板", renameBoardPrompt: "該看板的新顯示名：", removeBoardAction: "刪除看板", removeBoardConfirm: "刪除看板 {board}？已歸檔工作仍保留在資料庫中，看板本身將被刪除。", workdirAction: "設定看板工作目錄", workdirTitle: "看板工作目錄", workdirCurrent: "目前工作目錄：{path}", workdirNone: "尚未設定工作目錄——工作將回退到閘道預設 cwd。", workdirUp: "上層", workdirClear: "清除", workdirUse: "使用此目錄", workdirFailed: "瀏覽失敗：{error}", workdirEmpty: "此處沒有子目錄。", promoteAction: "晉升", promotePrompt: "將該工作晉升為就緒的原因（選填）：", reclaimAction: "回收", reclaimConfirm: "回收該執行中的工作？活動的工作者認領將被釋放，工作回到就緒狀態。", runsTitle: "執行歷史", statsOldestReady: "最舊就緒 {age}", diagnosticsTitle: "診斷", 
  },
  projects: {
  ...
  jobs: {
    ...
    blueprintsAction: "範本", blueprintsTitle: "自動化範本", blueprintsFilterPh: "篩選範本…", blueprintsEmpty: "沒有符合篩選條件的範本。", blueprintsFailed: "範本載入失敗：{error}", blueprintCreate: "建立工作", suggestionsTitle: "建議的自動化", suggestionsAccept: "接受", suggestionsDismiss: "忽略", ideasAction: "點子", runsHistory: "執行歷史", runsHistoryTitle: "執行歷史——{name}", runsEmpty: "該工作還沒有執行記錄。", suggestionsScheduled: "已建立排程工作「{name}」（{schedule}），可在工作清單中管理。", suggestionsSeeded: "已新增 {count} 個入門自動化建議，請在此檢閱。", suggestionsSeedNone: "沒有新的入門自動化可新增（已全部推薦或忽略過）。",
  ...
  sessionsView: {
    ...
    exportTitle: "將選取會話匯出為 Markdown", exportHtmlTitle: "將選取會話匯出為獨立 HTML", exportJsonTitle: "將選取會話匯出為可攜式 JSON（可重新匯入）", import: "⭱ 匯入", importTitle: "從可攜式 JSON 匯出檔匯入會話", imported: "已匯入 {imported} 個會話、{messages} 則訊息；跳過 {skipped}。", importPreview: "匯入此檔案？將新增 {imported} 個會話（{messages} 則訊息），{skipped} 個已存在。", importCancelled: "已取消匯入。", importParseFailed: "匯入失敗：檔案不是會話匯出 JSON 負載。", importFailed: "匯入失敗：{error}", msgCount: "{count} 則訊息", project: "專案", source: "來源", metaEnded: "已結束", metaDuration: "時長", stats: "{sessions} 個會話 \u00b7 {messages} 則訊息 \u00b7 磁碟佔用 {size}",
    ...
    forkTitle: "將此會話分叉為新分支", forked: "已分叉為 {id}", forkFailed: "分叉失敗:{error}", openInChat: "→ 聊天", openInChatTitle: "在聊天視圖中開啟此工作階段",
    ...
    renameTitle: "重新命名此會話", retitleTitle: "經 LLM 重新產生標題", retitleApplied: "已重新產生標題：{label}", retitleUnchanged: "標題已是最新。", retitleFailed: "標題重新產生失敗（provider 不可達或被拒絕）。", renamePrompt: "新標題（留空清除）：", renamed: "會話已重新命名。", renameFailed: "重新命名失敗:{error}",
  },
  modelsView: {
    ...
    gatewayTitle: "閘道模型", gatewayContext: "內文窗口", gatewaySet: "設為閘道模型", gatewaySetConfirm: "將閘道模型切換為 {provider}/{model}？閘道重啟後對新工作階段生效。", gatewaySetDone: "閘道模型已更新——重啟閘道後生效。", gatewaySetFailed: "模型切換失敗：{error}", recommendedDefault: "推薦預設", endpointsTitle: "自訂端點", endpointsEmpty: "尚未配置自訂端點。", endpointsTest: "測試", endpointsActivate: "啟用", endpointsActivated: "自訂端點已啟用——重啟閘道後生效。", endpointsDeleteConfirm: "刪除 {id} 端點及其儲存的密鑰？", endpointsSaved: "端點已儲存。", endpointsFailed: "端點操作失敗：{error}", auxTitle: "輔助任務模型", auxInherit: "繼承主模型", auxProviderPh: "供應商（auto）", auxModelPh: "模型（auto）", auxSave: "固定", auxReset: "重置", auxSaved: "已固定 {task}。", auxResetDone: "{task} 已重置為主模型。", auxFailed: "輔助模型更新失敗：{error}", moaTitle: "MoA（多模型合議）預設", moaEmpty: "尚未配置 MoA 預設——請在下方 JSON 編輯器中新增。", moaRefs: "參考模型", moaAggregator: "聚合模型", moaHint: "編輯預設 JSON（default_preset + presets）並儲存，以取代 config.toml 中的 [moa]。", moaSave: "儲存 MoA 設定", moaSaved: "MoA 設定已儲存——重啟閘道後生效。", moaFailed: "MoA 儲存失敗：{error}", moaBadJson: "MoA JSON 無效。",
  ...
  computerUsePanel: { title: "Computer Use（電腦操作）", driver: "驅動", notInstalled: "未安裝", telemetry: "遙測", maxDimension: "最大影像邊長", captureAfter: "截圖時機", overlay: "覆蓋層", overlayAuto: "自動", overlayOn: "強制開", overlayOff: "強制關", runDoctor: "執行體檢", running: "執行中…", overall: "總體" },
    computerUseSettingsPanel: { title: "Computer Use 設定", disabledWord: "已停用", apply: "應用", clear: "清除" },
  secretsPanel: { title: "金鑰源", order: "源順序", noneEnabled: "未啟用任何源", configured: "已配置", noCommand: "未設置命令", bwsMissing: "未找到 bws", tokenPresent: "令牌存在", tokenMissing: "令牌缺失", opMissing: "未找到 op", bindingsWord: "條綁定", tokenOptional: "無服務令牌（互動式認證仍可用）", preserve: "保留已有" , syncNow: "立即同步", applyNow: "寫入 .env", syncing: "同步中…", applying: "寫入中…", dryRunNote: "試運行——未寫入任何內容。應用可將勝出值持久化到 .env。", applyNote: "已持久化到 .env——值將在閘道下次啟動時載入。", appliedLabel: "已應用", skippedExistingLabel: "已跳過（已有值）", skippedProtectedLabel: "已跳過（受保護）", conflictsLabel: "衝突", errorsLabel: "錯誤", persistedLabel: "已持久化", noneWord: "無", secretsWord: "個金鑰" },
  syncPanel: { title: "技能同步", device: "裝置", unnamed: "未命名", gate: "閘門", gateActive: "活躍", gateInert: "未啟用", optedIn: "已加入", noneOptedIn: "無（ulnclaw sync enable <skill>）", fetchRemote: "拉取遠端", fetching: "拉取中…", remoteUnavailable: "遠端清單不可用", remoteEmpty: "遠端清單為空。", fromWord: "來自", filesWord: "個檔案" , pull: "立即拉取", push: "立即推送", pulling: "拉取中…", pushing: "推送中…", pulledWord: "已拉取", pushedWord: "已推送", nothingNew: "沒有新內容可拉取。", nothingToPush: "沒有可推送的內容。" },
  ...
  desktopShell: { aboutTitle: "關於 ulnclaw", aboutBody: "桌面外殼 v{version} · 閘道埠 {port} · 二進位：{binary}", binaryNotFound: "未找到", zoomChanged: "縮放：{percent}%", quitGuard: "仍有回合在執行——現在結束將中斷它。仍要結束嗎？" },
  metricsPanel: { title: "Prometheus 指標", summary: "顯示 /metrics 原始輸出" },
  egressPanel: { title: "出站代理" },
  channelsPanel: { title: "訊息通道", enabled: "已啟用", disabled: "未啟用", noneEnabled: "（無）", test: "測試", stateConnected: "已連線", stateNotConfigured: "未設定", summary: "連線狀況", summaryValue: "已連線 {connected}/{enabled}", homeChannel: "主頻道", knownChannels: "已知 {count} 個", recent: "最近活躍" , envTitle: "環境變數", envNotSet: "未設定", envPlaceholder: "新值", envReplace: "替換值", envSet: "設定", envClear: "清除", envNote: "值唯寫不讀（GET 僅返回遮罩預覽）；重啟閘道後生效。" },
  gatewayHealth: { title: "閘道健康", ok: "正常", degraded: "降級", overall: "總體狀態", stateDb: "工作階段儲存", config: "設定", model: "模型", disk: "磁碟", gateway: "平台", queues: "背景佇列", usedPercent: "已用 {pct}%", connectedPlatforms: "已連線 {connected}/{total}", queueCounts: "活動 {runs} \u00b7 排隊 {queued}", gatewayState: "閘道狀態", busy: "忙碌", activeAgents: "活動回合", uptime: "執行時長", pid: "PID", restartLoop: "重啟循環斷路器", tripped: "已觸發", calm: "平靜", previousExit: "上次結束", exitClean: "乾淨", exitUnclean: "非正常", exitUnknown: "未知", codeSkew: "程式碼偏差", codeSkewStale: "已過時" },
  ...
  gatewaySettingsPanel: { title: "閘道設定", address: "監聽位址", apiKey: "API 金鑰", multiplex: "多 profile 複用", profileRoutes: "profile 路由數", messageTimestamps: "訊息時間戳", loopWatchdog: "執行階段看門狗", systemdWatchdog: "systemd 看門狗", sessionCap: "工作階段上限", stallTimeout: "停滯逾時", envOverride: "環境變數覆蓋", apply: "套用", clear: "清除" },
  agentSettingsPanel: { title: "代理設定", iterations: "迭代預算", approvalGate: "審批開關", concurrentTools: "並行工具", contextBudget: "上下文預算", verbose: "詳細記錄", envProbe: "環境探測", reasoning: "推理強度", serviceTier: "服務層級", personality: "人格", defaultWord: "預設", apply: "套用", clear: "清除" },
  ...
  palette: {
    ...
    openSettings: "開啟閘道設定…", refreshSessions: "重新整理工作階段清單", restartGateway: "重啟閘道", gatewayLog: "檢視閘道日誌", openWorkingDir: "在檔案管理器中開啟工作目錄",
    updateCheck: "檢查更新", shortcuts: "鍵盤快捷鍵", notifications: "通知歷史", kanbanDispatch: "派發看板任務", kanbanDispatched: "看板派發：{spawned} 派生 · {promoted} 晉升 · {reclaimed} 回收", kanbanDispatchFailed: "看板派發失敗：{error}", kanbanQuickAdd: "新增看板任務…", kanbanQuickAddPrompt: "任務標題：", kanbanQuickAdded: "已建立看板任務：{id} —— {title}", kanbanQuickAddFailed: "看板任務建立失敗：{error}", kanbanBoardSwitch: "切換看板…", kanbanBoardSwitched: "已切換看板：{board}", kanbanBoardsFailed: "看板清單載入失敗：{error}", kanbanBoardsEmpty: "暫無可用看板", toggleSidebar: "切換側欄", themePicker: "切換主題…", themePickerTitle: "儀表盤主題", themeFailed: "主題載入失敗：{error}", fontPicker: "切換字體…", fontPickerTitle: "儀表盤字體", fontFailed: "字體載入失敗：{error}", copySessionId: "複製工作階段 ID", openSessionWindow: "在新視窗開啟工作階段", exportPickerTitle: "將工作階段匯出為…", copyLastReply: "複製最後一則助手回覆", lastReplyCopied: "已複製最後一則助手回覆。", lastReplyNone: "還沒有可複製的助手回覆。", forkSession: "分叉目前工作階段", sessionForked: "已分叉工作階段：{label}", forkFailed: "工作階段分叉失敗：{error}", toggleHideArchived: "切換隱藏已歸檔工作階段", newSessionInProject: "在使用中的專案新建工作階段", noActiveProject: "目前沒有使用中的專案——請先在專案視圖設定。", projectSessionCreated: "已在專案中啟動工作階段：{label}", projectsLoadFailed: "專案清單載入失敗：{error}", archiveSession: "歸檔目前工作階段", unarchiveSession: "還原目前工作階段（取消歸檔）", sessionArchived: "已歸檔工作階段：{label}", sessionUnarchived: "已還原工作階段：{label}", sessionArchiveFailed: "工作階段歸檔失敗：{error}", viewInSessionsBrowser: "在會話瀏覽器中檢視目前會話", markAllRead: "將所有工作階段標為已讀", copyTranscript: "複製工作階段轉錄為 Markdown", copiedTranscript: "轉錄已複製到剪貼簿", copyTranscriptFailed: "複製轉錄失敗：{error}", retitleSkills: "修復洩漏的 /skill 工作階段標題…", retitleTitle: "重新命名 /skill 工作階段——已掃描 {count} 個", retitleNone: "未發現洩漏的 /skill 標題。", retitleRejected: "已拒絕", retitleApply: "套用新標題", retitleClose: "關閉", retitleApplied: "已套用 {count} 個新標題", retitleFailed: "重新命名失敗：{error}", unreadOnly: "僅顯示未讀工作階段（切換）", pinSession: "置頂目前工作階段", unpinSession: "取消置頂目前工作階段", sessionPinned: "已置頂 {label}", sessionUnpinned: "已取消置頂 {label}", retitleCurrent: "經 LLM 重新產生會話標題", retitledCurrent: "已重新產生標題：{label}", retitleCurrentUnchanged: "標題已是最新。", retitleCurrentFailed: "標題重新產生失敗（provider 不可達或被拒絕）。", fileTree: "切換檔案樹", quickEntry: "快速輸入…",
...
const ja: Translations = {
  chrome: {
    ...
    inputPlaceholder: "ulnclaw にメッセージ…（Enter で送信、Shift+Enter で改行）", charCountTitle: "文字数", reasoningTitle: "推論深度 — クリックでレベルを固定（agent.reasoning_effort に永続化）", reasoningAuto: "自動", personalityTitle: "パーソナリティ — クリックで有効化（agent.personality に永続化）", personalityDefault: "デフォルト", fastTitle: "優先処理 — クリックで切替（対応モデルに service_tier=priority を送信）", fastOn: "高速", fastOff: "通常", approvalsTitle: "承認モード — クリックで切替（manual|smart|off；approvals.mode に永続化）",
    send: "送信",
    ...
    manageProcess: "ゲートウェイプロセスを管理（アプリと連動して起動/停止）", autostart: "ログイン時に ulnclaw を起動", autostartFailed: "ログイン時の起動設定を変更できませんでした。", popoutFailed: "セッションウィンドウを開けませんでした: {error}", gatewayRespawned: "ゲートウェイがクラッシュしました — 自動的に再起動しました。", gatewayLogTitle: "ゲートウェイログ", gatewayLogRefresh: "更新", gatewayLogClose: "閉じる", gatewayLogEmpty: "ゲートウェイの出力はまだありません。", openDirFailed: "ディレクトリを開けませんでした: {error}", reopenLast: "起動時に最後のセッションを再び開く",
    charWarn: "入力欄の警告しきい値（文字数）",
    charLimit: "入力欄のハードリミット（文字数、0 = 無効）",
    charLimitExceeded: "メッセージが長すぎます（{length}/{limit} 文字）— 短くしてから送信してください",
    notifySystem: "実行終了時にシステム通知を表示", completionChime: "ターン完了時にチャイムを鳴らす", hideToTray: "閉じるときに終了せずトレイへ格納",
    delete: "削除",
    ...
    scModelPicker: "モデルピッカーを開く", scNewSession: "新規セッション", scCycle: "セッションを切り替え", scArchive: "現在のセッションをアーカイブ/復元", scExport: "現在のセッションをエクスポート", scFileTree: "ファイルツリーを切り替え", scQuickEntry: "クイックエントリーを開く", scGatewayLog: "ゲートウェイログを開く",
    scSessionPicker: "セッションピッカーを開く", scSettings: "設定を開く", scSidebar: "サイドバーを切り替え",
    scPalette: "コマンドパレット", scFind: "チャット内検索", scFocus: "入力欄にフォーカス",
    scShortcuts: "このダイアログを表示", scRefreshView: "アクティブなビューを更新", scRecall: "送信済みプロンプトを呼び出し（入力欄）", scSessionNav: "セッション一覧をキー操作（サイドバー）", scDayJump: "日付区切り線間をジャンプ（チャット）", scEndHome: "最新 / 最古のメッセージへジャンプ（チャット）",
  },
  session: {
    ...
    projectBadge: "プロジェクト：{project}", endReasonTitle: "終了理由：{reason}",
  ...
  slash: {
    ...
    status: "セッション + agent ステータス（/status）", context: "このセッションのコンテキスト使用量（/context）", whoami: "プロセス識別情報（/whoami）", version: "ulnclaw バージョン（/version）", commands: "/help のエイリアス", profile: "設定済みプロファイルを一覧（/profile）", model: "モデルを表示または永続化（/model [provider model]）", reasoning: "推論深度を表示または永続化（/reasoning [level|clear]）", memory: "メモリストアの状態（/memory）", sessions: "最近のセッションを一覧（/sessions [N]）", stop: "このセッションの実行中 run を停止（/stop）", retry: "最後のユーザー発言まで切り詰めて再実行（/retry）", undo: "直近 N ターンのユーザー発言を削除し、削除内容を表示（/undo [N]）", verbose: "詳細ログを表示または永続化（/verbose [on|off]）", yolo: "危険コマンドを自動承認 — approvals.mode=off（/yolo [on|off]）", personality: "パーソナリティを一覧・有効化（/personality [name|none]）", goal: "常設ゴール — 設定/状態/表示/一時停止/再開/クリア（/goal [テキスト]）", subgoal: "アクティブなゴールへの追加基準（/subgoal [テキスト|remove N|clear]）", reloadMcp: "MCP ツールサーフェスを再構築（/reload-mcp [confirm]）", fast: "優先処理の切替（/fast [on|off] [--global]）", branch: "このセッションを子ブランチにフォーク（/branch [名前]）", diff: "セッション cwd の git 変更（/diff [working|staged|all|session] [--stat]）", rollback: "ファイルシステムチェックポイントの一覧/復元（/rollback [N|hash]）", blueprint: "自動化ブループリント — カタログ、ガイド付き設定、直接作成（/blueprint [名前] [slot=val…]）", cron: "スケジュールジョブの管理 — 一覧/表示/停止/再開/実行/削除/状態（/cron）", suggestions: "提案された自動化 — 一覧/承認/却下/カタログ（/suggestions）", init: "プロジェクトスキャンから AGENTS.md を生成/更新（/init [メモ]）", agents: "稼働中のエージェントと最近の委任（/agents）", journey: "学習タイムライン — スキルとメモリカード（/journey）", snapshot: "状態スナップショット — 作成/一覧/復元/整理（/snapshot）", platforms: "メッセージングプラットフォームの接続状態（/platforms）", curator: "スキル整備 — 状態/実行/停止/ピン/アーカイブ（/curator）", bundles: "スキルバンドル — 一覧/表示；/<slug> で起動（/bundles）", toolsets: "ツールセットカタログ（登録済みは ✓ 表示）（/toolsets）", approve: "保留中の危険コマンドを承認（/approve [once|session|always] [run-id]）", deny: "保留中の危険コマンドを拒否（/deny [run-id]）", background: "プロンプトをバックグラウンド実行（/background <プロンプト>）", restart: "アクティブランをドレインして終了（コード 75）し、スーパーバイザーが再起動（/restart）", queue: "次のターン用にプロンプトをキュー（中断なし）（/queue <プロンプト>）", steer: "次のツール呼び出し後にメッセージを注入（中断なし）（/steer <プロンプト>）", approvals: "危険コマンド承認モードを表示/永続化（/approvals [manual|smart|off]）", debug: "<home>/debug-bundles にレダクト済みデバッグバンドルを書き出す（/debug [no-redact]）", image: "次のプロンプトにローカル画像を添付（/image <パス>）",
    ...
    platform: "ゲートウェイプラットフォームの再試行制御（list/pause/resume）",
  },
  busy: {
    titlePlain: "ビジー時の動作",
    title: "ビジー時の動作：{mode} — クリックで変更",
    queue: "次のターンへキュー",
    steer: "実行中ターンへステア",
    interrupt: "中断してから送信",
    queued: "次のターンへキューしました（{count} 件待ち）",
    steerSent: "実行中のターンへ注入しました",
    interruptQueued: "停止を要求しました — メッセージはキュー済み（{count} 件待ち）",
    modeChanged: "ビジー時の動作：{mode}",
  },
  quickEntry: { placeholder: "何でも聞いてください…", disconnected: "ゲートウェイ未接続", hint: "Enter で送信 · Esc で閉じる", reconnectHint: "ゲートウェイに再接続中…", targetCurrent: "このセッション", targetNew: "新規セッション" },
  ...
  bridge: {
    ...
    sessionCreated: "他のクライアントがセッションを作成しました", sessionDeleted: "他のクライアントがセッションを削除しました",
  },
  kanban: {
    ...
    newTaskTitle: "新規タスク", newTaskTitleField: "タイトル", newTaskBody: "説明", createAction: "作成", newBoardAction: "新規ボード", newBoardPrompt: "新しいボードの slug（小文字・数字・ダッシュ）：", newBoardNamePrompt: "ボードの表示名（任意）：", renameBoardAction: "ボード名を変更", renameBoardPrompt: "このボードの新しい表示名：", removeBoardAction: "ボードを削除", removeBoardConfirm: "ボード {board} を削除しますか？アーカイブ済みタスクはデータベースに残り、ボード自体が削除されます。", workdirAction: "ボードの作業ディレクトリを設定", workdirTitle: "ボードの作業ディレクトリ", workdirCurrent: "現在の作業ディレクトリ：{path}", workdirNone: "作業ディレクトリ未設定——タスクはゲートウェイの既定 cwd にフォールバックします。", workdirUp: "上へ", workdirClear: "クリア", workdirUse: "このディレクトリを使用", workdirFailed: "参照に失敗：{error}", workdirEmpty: "ここにサブディレクトリはありません。", promoteAction: "昇格", promotePrompt: "このタスクを ready に昇格する理由（任意）：", reclaimAction: "回収", reclaimConfirm: "実行中のこのタスクを回収しますか？アクティブなワーカーのクレームを解放し、タスクを ready に戻します。", runsTitle: "実行履歴", statsOldestReady: "最長待ち ready {age}", diagnosticsTitle: "診断", 
  },
  projects: {
  ...
  jobs: {
    ...
    blueprintsAction: "テンプレート", blueprintsTitle: "自動化テンプレート", blueprintsFilterPh: "テンプレートを絞り込み…", blueprintsEmpty: "絞り込み条件に一致するテンプレートはありません。", blueprintsFailed: "テンプレートの読み込みに失敗：{error}", blueprintCreate: "ジョブを作成", suggestionsTitle: "提案された自動化", suggestionsAccept: "承認", suggestionsDismiss: "却下", ideasAction: "アイデア", runsHistory: "実行履歴", runsHistoryTitle: "実行履歴 — {name}", runsEmpty: "このジョブにはまだ実行記録がありません。", suggestionsScheduled: "「{name}」（{schedule}）をスケジュールしました。ジョブ一覧で管理できます。", suggestionsSeeded: "{count} 件のスターター自動化を追加しました。こちらで確認してください。", suggestionsSeedNone: "追加できる新しいスターター自動化はありません（すべて提案済みか却下済み）。",
  ...
  sessionsView: {
    ...
    forkTitle: "このセッションを新しいブランチにフォーク", forked: "{id} としてフォークしました", forkFailed: "フォークに失敗しました: {error}", openInChat: "→ チャット", openInChatTitle: "このセッションをチャットビューで開く",
    ...
    renameTitle: "このセッションの名前を変更", retitleTitle: "LLM でタイトルを再生成", retitleApplied: "タイトルを再生成しました：{label}", retitleUnchanged: "タイトルは既に最新です。", retitleFailed: "タイトルの再生成に失敗しました（プロバイダ到達不能または拒否）。", renamePrompt: "新しいタイトル（空でクリア）:", renamed: "セッション名を変更しました。", renameFailed: "名前の変更に失敗しました: {error}",
  },
  modelsView: {
    ...
    gatewayTitle: "ゲートウェイモデル", gatewayContext: "コンテキスト", gatewaySet: "ゲートウェイモデルに設定", gatewaySetConfirm: "ゲートウェイモデルを {provider}/{model} に切り替えますか？ゲートウェイ再起動後、新しいセッションに適用されます。", gatewaySetDone: "ゲートウェイモデルを更新しました——再起動後に適用されます。", gatewaySetFailed: "モデル切り替えに失敗しました: {error}", recommendedDefault: "推奨デフォルト", endpointsTitle: "カスタムエンドポイント", endpointsEmpty: "カスタムエンドポイントは未設定です。", endpointsTest: "テスト", endpointsActivate: "有効化", endpointsActivated: "カスタムエンドポイントを有効化しました——再起動後に適用されます。", endpointsDeleteConfirm: "エンドポイント {id} とその保存キーを削除しますか？", endpointsSaved: "エンドポイントを保存しました。", endpointsFailed: "エンドポイント操作に失敗しました: {error}", auxTitle: "補助タスクモデル", auxInherit: "メインを継承", auxProviderPh: "プロバイダー（auto）", auxModelPh: "モデル（auto）", auxSave: "固定", auxReset: "リセット", auxSaved: "{task} を固定しました。", auxResetDone: "{task} をメインに戻しました。", auxFailed: "補助モデルの更新に失敗しました: {error}", moaTitle: "Mixture-of-Agents プリセット", moaEmpty: "MoA プリセットは未設定です——下の JSON エディターで追加してください。", moaRefs: "リファレンス", moaAggregator: "アグリゲーター", moaHint: "プリセット JSON（default_preset + presets）を編集して保存すると、config.toml の [moa] が置き換えられます。", moaSave: "MoA 設定を保存", moaSaved: "MoA 設定を保存しました——再起動後に適用されます。", moaFailed: "MoA の保存に失敗しました: {error}", moaBadJson: "MoA JSON が無効です。",
  ...
  gatewaySettingsPanel: { title: "ゲートウェイ設定", address: "リスナー", apiKey: "API キー", multiplex: "プロファイルマルチプレクス", profileRoutes: "プロファイルルート数", messageTimestamps: "メッセージタイムスタンプ", loopWatchdog: "ループウォッチドッグ", systemdWatchdog: "systemd ウォッチドッグ", sessionCap: "セッション上限", stallTimeout: "ストールタイムアウト", envOverride: "環境変数オーバーライド", apply: "適用", clear: "クリア" },
  agentSettingsPanel: { title: "エージェント設定", iterations: "イテレーション予算", approvalGate: "承認ゲート", concurrentTools: "並行ツール", contextBudget: "コンテキスト予算", verbose: "詳細ログ", envProbe: "環境プローブ", reasoning: "推論労力", serviceTier: "サービスティア", personality: "パーソナリティ", defaultWord: "既定", apply: "適用", clear: "クリア" },
  ...
  palette: {
    ...
    openSettings: "ゲートウェイ設定を開く…", refreshSessions: "セッション一覧を更新", restartGateway: "ゲートウェイを再起動", gatewayLog: "ゲートウェイログを表示", openWorkingDir: "作業ディレクトリをファイルマネージャで開く",
    updateCheck: "更新を確認", shortcuts: "キーボードショートカット", notifications: "通知履歴", kanbanDispatch: "カンバンタスクをディスパッチ", kanbanDispatched: "ディスパッチ結果：{spawned} 起動 · {promoted} 昇格 · {reclaimed} 回収", kanbanDispatchFailed: "ディスパッチに失敗：{error}", kanbanQuickAdd: "新しいカンバンタスク…", kanbanQuickAddPrompt: "タスクタイトル：", kanbanQuickAdded: "カンバンタスクを作成しました：{id} — {title}", kanbanQuickAddFailed: "カンバンタスクの作成に失敗：{error}", kanbanBoardSwitch: "カンバンボードを切り替え…", kanbanBoardSwitched: "カンバンボードを切り替えました：{board}", kanbanBoardsFailed: "カンバンボードの読み込みに失敗：{error}", kanbanBoardsEmpty: "利用可能なカンバンボードがありません", toggleSidebar: "サイドバーを表示/非表示", themePicker: "テーマを切り替え…", themePickerTitle: "ダッシュボードテーマ", themeFailed: "テーマの読み込みに失敗：{error}", fontPicker: "フォントを切り替え…", fontPickerTitle: "ダッシュボードフォント", fontFailed: "フォントの読み込みに失敗：{error}", copySessionId: "セッション ID をコピー", openSessionWindow: "セッションを新しいウィンドウで開く", exportPickerTitle: "セッションを次の形式でエクスポート…", copyLastReply: "最後のアシスタント回答をコピー", lastReplyCopied: "最後のアシスタント回答をコピーしました。", lastReplyNone: "コピーできるアシスタント回答がまだありません。", forkSession: "現在のセッションをフォーク", sessionForked: "セッションをフォークしました：{label}", forkFailed: "セッションのフォークに失敗：{error}", toggleHideArchived: "アーカイブ済みセッションの非表示を切り替え", newSessionInProject: "アクティブプロジェクトで新しいセッション", noActiveProject: "アクティブなプロジェクトがありません——プロジェクトビューで設定してください。", projectSessionCreated: "プロジェクト内でセッションを開始しました：{label}", projectsLoadFailed: "プロジェクト一覧の読み込みに失敗：{error}", archiveSession: "現在のセッションをアーカイブ", unarchiveSession: "現在のセッションを復元（アーカイブ解除）", sessionArchived: "セッションをアーカイブしました：{label}", sessionUnarchived: "セッションを復元しました：{label}", sessionArchiveFailed: "セッションのアーカイブに失敗：{error}", viewInSessionsBrowser: "現在のセッションをセッションビューで開く", markAllRead: "すべてのセッションを既読にする", copyTranscript: "セッション記録を Markdown としてコピー", copiedTranscript: "記録をクリップボードにコピーしました", copyTranscriptFailed: "記録のコピーに失敗しました：{error}", retitleSkills: "漏洩した /skill セッションタイトルを修正…", retitleTitle: "/skill セッションのタイトル修正 — {count} 件スキャン", retitleNone: "漏洩した /skill タイトルは見つかりませんでした。", retitleRejected: "却下", retitleApply: "新しいタイトルを適用", retitleClose: "閉じる", retitleApplied: "{count} 件の新しいタイトルを適用しました", retitleFailed: "タイトル修正に失敗しました：{error}", unreadOnly: "未読セッションのみ表示（切り替え）", pinSession: "現在のセッションを上部に固定", unpinSession: "現在のセッションの固定を解除", sessionPinned: "{label} を上部に固定しました", sessionUnpinned: "{label} の固定を解除しました", retitleCurrent: "LLM でセッションタイトルを再生成", retitledCurrent: "タイトルを再生成しました：{label}", retitleCurrentUnchanged: "タイトルは既に最新です。", retitleCurrentFailed: "タイトルの再生成に失敗しました（プロバイダ到達不能または拒否）。", fileTree: "ファイルツリーを切り替え", quickEntry: "クイックエントリー…",
...
const ar: Translations = {
  chrome: {
    ...
    inputPlaceholder: "راسل ulnclaw… (Enter للإرسال، Shift+Enter لسطر جديد)", charCountTitle: "عدد الأحرف", reasoningTitle: "جهد الاستدلال — انقر لتثبيت مستوى (يُحفظ في agent.reasoning_effort)", reasoningAuto: "تلقائي", personalityTitle: "الشخصية — انقر لتفعيل شخصية (تُحفظ في agent.personality)", personalityDefault: "افتراضي", fastTitle: "المعالجة ذات الأولوية — انقر للتبديل (service_tier=priority للنماذج المدعومة)", fastOn: "سريع", fastOff: "عادي", approvalsTitle: "وضع الموافقة — انقر للتبديل (manual|smart|off؛ يُحفظ في approvals.mode)",
    send: "إرسال",
    ...
    manageProcess: "إدارة عملية البوابة (تشغيل/إيقاف مع التطبيق)", autostart: "تشغيل ulnclaw عند تسجيل الدخول", autostartFailed: "تعذر تغيير إعداد التشغيل عند تسجيل الدخول.", popoutFailed: "تعذر فتح نافذة الجلسة: {error}", gatewayRespawned: "انهارت البوابة — تمت إعادة تشغيلها تلقائيًا.", gatewayLogTitle: "سجل البوابة", gatewayLogRefresh: "تحديث", gatewayLogClose: "إغلاق", gatewayLogEmpty: "لم يتم التقاط أي إخراج للبوابة بعد.", openDirFailed: "تعذر فتح المجلد: {error}", reopenLast: "إعادة فتح آخر جلسة عند التشغيل",
    ...
    notifySystem: "إشعار النظام عند انتهاء التشغيل", completionChime: "تشغيل نغمة عند اكتمال الدور", hideToTray: "الإخفاء إلى علبة النظام عند الإغلاق بدلاً من الخروج",
    delete: "حذف",
    ...
    scModelPicker: "فتح منتقي النماذج", scNewSession: "جلسة جديدة", scCycle: "التنقل بين الجلسات", scArchive: "أرشفة/استعادة الجلسة الحالية", scExport: "تصدير الجلسة الحالية", scFileTree: "تبديل شجرة الملفات", scQuickEntry: "فتح الإدخال السريع", scGatewayLog: "فتح سجل البوابة",
    ...
    scShortcuts: "إظهار هذا الحوار", scRefreshView: "تحديث العرض النشط", scRecall: "استدعاء المطالبات المرسلة (المؤلف)", scSessionNav: "التنقل في قائمة الجلسات (الشريط الجانبي)", scDayJump: "التنقل بين فواصل الأيام (الدردشة)", scEndHome: "القفز إلى أحدث / أقدم رسالة (الدردشة)",
  },
  session: {
    ...
    projectBadge: "المشروع: {project}", endReasonTitle: "سبب الانتهاء: {reason}",
  ...
  slash: {
    ...
    status: "حالة الجلسة والوكيل (/status)", context: "استخدام نافذة السياق لهذه الجلسة (/context)", whoami: "هوية العملية (/whoami)", version: "إصدار ulnclaw (/version)", commands: "اسم مستعار لـ /help", profile: "عرض الملفات الشخصية المكونة (/profile)", model: "عرض النموذج أو حفظه (/model [provider model])", reasoning: "عرض جهد الاستدلال أو حفظه (/reasoning [level|clear])", memory: "حالة مخزن الذاكرة (/memory)", sessions: "عرض الجلسات الأخيرة (/sessions [N])", stop: "إيقاف التشغيل الجاري لهذه الجلسة (/stop)", retry: "القطع حتى آخر رسالة مستخدم وإعادة تشغيلها (/retry)", undo: "إسقاط آخر N أدوار مستخدم مع عرض ما أُزيل (/undo [N])", verbose: "عرض أو حفظ السجل التفصيلي (/verbose [on|off])", yolo: "الموافقة التلقائية على الأوامر الخطيرة — approvals.mode=off (/yolo [on|off])", personality: "عرض أو تفعيل شخصية (/personality [name|none])", goal: "الهدف الدائم — تعيين/حالة/عرض/إيقاف/استئناف/مسح (/goal [نص])", subgoal: "معايير إضافية على الهدف النشط (/subgoal [نص|remove N|clear])", reloadMcp: "إعادة بناء سطح أدوات MCP (/reload-mcp [confirm])", fast: "تبديل المعالجة ذات الأولوية (/fast [on|off] [--global])", branch: "تفريع الجلسة الحالية إلى فرع تابع (/branch [اسم])", diff: "تغييرات git في دليل الجلسة (/diff [working|staged|all|session] [--stat])", rollback: "عرض أو استعادة نقاط التفتيش (/rollback [N|hash])", blueprint: "مخططات الأتمتة — الفهرس أو الإعداد الموجّه أو الإنشاء المباشر (/blueprint [name] [slot=val…])", cron: "إدارة المهام المجدولة — عرض/إيقاف مؤقت/استئناف/تشغيل/حذف/حالة (/cron)", suggestions: "الأتمتة المقترحة — عرض/قبول/رفض/فهرس (/suggestions)", init: "إنشاء AGENTS.md أو تحديثه من فحص المشروع (/init [ملاحظات])", agents: "الوكلاء النشطون والتفويضات الأخيرة (/agents)", journey: "الخط الزمني للتعلم — المهارات وبطاقات الذاكرة (/journey)", snapshot: "لقطات الحالة — إنشاء/عرض/استعادة/تشذيب (/snapshot)", platforms: "حالة اتصال منصات المراسلة (/platforms)", curator: "صيانة المهارات — حالة/تشغيل/إيقاف/تثبيت/أرشفة (/curator)", bundles: "حزم المهارات — عرض/تفاصيل؛ /<slug> يستدعيها (/bundles)", toolsets: "فهرس أطقم الأدوات مع تمييز المسجلة (/toolsets)", approve: "الموافقة على أمر خطير معلق (/approve [once|session|always] [run-id])", deny: "رفض أمر خطير معلق (/deny [run-id])", background: "تشغيل مطالبة في مهمة خلفية متتبعة (/background <مطالبة>)", restart: "تفريغ العمليات الجارية والخروج (الرمز 75) ليعيد المشرف التشغيل (/restart)", queue: "وضع مطالبة في الطابور للدور التالي دون مقاطعة (/queue <مطالبة>)", steer: "حقن رسالة بعد استدعاء الأداة التالي دون مقاطعة (/steer <مطالبة>)", approvals: "عرض أو حفظ وضع الموافقة على الأوامر الخطرة (/approvals [manual|smart|off])", debug: "كتابة حزمة تصحيح منقحة تحت <home>/debug-bundles (/debug [no-redact])", image: "إرفاق صورة محلية بمطالبتك التالية (/image <مسار>)",
    ...
    platform: "التحكم في إعادة محاولة منصات البوابة (list/pause/resume)",
  },
  busy: {
    titlePlain: "السلوك أثناء الانشغال",
    title: "السلوك أثناء الانشغال: {mode} — انقر للتغيير",
    queue: "وضع في الطابور للدور التالي",
    steer: "حقن في الدور الجاري",
    interrupt: "مقاطعة ثم إرسال",
    queued: "تم الوضع في الطابور للدور التالي ({count} في الانتظار)",
    steerSent: "تم الحقن في الدور الجاري",
    interruptQueued: "طُلب الإيقاف — الرسالة في الطابور ({count} في الانتظار)",
    modeChanged: "السلوك أثناء الانشغال: {mode}",
  },
  quickEntry: { placeholder: "اسأل عن أي شيء…", disconnected: "البوابة غير متصلة", hint: "Enter للإرسال · Esc للإغلاق", reconnectHint: "جارٍ إعادة الاتصال بالبوابة…", targetCurrent: "هذه الجلسة", targetNew: "جلسة جديدة" },
  ...
  bridge: {
    ...
    sessionCreated: "جلسة جديدة من عميل آخر", sessionDeleted: "حذف عميل آخر جلسة",
  },
  kanban: {
    ...
    newTaskTitle: "مهمة جديدة", newTaskTitleField: "العنوان", newTaskBody: "الوصف", createAction: "إنشاء", newBoardAction: "لوحة جديدة", newBoardPrompt: "معرّف اللوحة الجديدة (أحرف صغيرة وأرقام وشرطات):", newBoardNamePrompt: "اسم العرض للوحة (اختياري):", renameBoardAction: "إعادة تسمية اللوحة", renameBoardPrompt: "اسم العرض الجديد لهذه اللوحة:", removeBoardAction: "حذف اللوحة", removeBoardConfirm: "حذف اللوحة {board}؟ تبقى المهام المؤرشفة في قاعدة البيانات وتُحذف اللوحة نفسها.", workdirAction: "تعيين مجلد عمل اللوحة", workdirTitle: "مجلد عمل اللوحة", workdirCurrent: "مجلد العمل الحالي: {path}", workdirNone: "لم يُعيَّن مجلد عمل بعد — تعود المهام إلى cwd الافتراضي للبوابة.", workdirUp: "أعلى", workdirClear: "مسح", workdirUse: "استخدام هذا المجلد", workdirFailed: "فشل الاستعراض: {error}", workdirEmpty: "لا توجد مجلدات فرعية هنا.", promoteAction: "ترقية", promotePrompt: "سبب ترقية المهمة إلى جاهز (اختياري):", reclaimAction: "استرداد", reclaimConfirm: "استرداد هذه المهمة الجارية؟ سيُحرَّر حجز العامل النشط وتعود المهمة إلى حالة الجاهز.", runsTitle: "سجل التشغيل", statsOldestReady: "أقدم جاهز {age}", diagnosticsTitle: "التشخيصات", 
  },
  projects: {
  ...
  jobs: {
    ...
    blueprintsAction: "القوالب", blueprintsTitle: "قوالب الأتمتة", blueprintsFilterPh: "تصفية القوالب…", blueprintsEmpty: "لا توجد قوالب تطابق التصفية.", blueprintsFailed: "فشل تحميل القوالب: {error}", blueprintCreate: "إنشاء المهمة", suggestionsTitle: "الأتمتة المقترحة", suggestionsAccept: "قبول", suggestionsDismiss: "رفض", ideasAction: "أفكار", runsHistory: "سجل التشغيل", runsHistoryTitle: "سجل التشغيل — {name}", runsEmpty: "لا توجد عمليات تشغيل مسجلة لهذه المهمة بعد.", suggestionsScheduled: "تمت جدولة '{name}' ({schedule}). يمكنك إدارتها في قائمة المهام.", suggestionsSeeded: "تمت إضافة {count} فكرة أتمتة أولية. راجعها هنا.", suggestionsSeedNone: "لا توجد أتمتة أولية جديدة للإضافة (مقترحة أو مرفوضة سابقًا).",
  ...
  sessionsView: {
    ...
    exportTitle: "تصدير الجلسة المحددة بصيغة Markdown", exportHtmlTitle: "تصدير الجلسة المحددة بصيغة HTML مستقلة", exportJsonTitle: "تصدير الجلسة المحددة بصيغة JSON محمولة (قابلة لإعادة الاستيراد)", import: "⭱ استيراد", importTitle: "استيراد الجلسات من تصدير JSON محمول", imported: "تم استيراد {imported} جلسة و{messages} رسالة؛ تم تخطي {skipped}.", importPreview: "استيراد هذا الملف؟ {imported} جلسة جديدة ({messages} رسالة)، {skipped} موجودة بالفعل.", importCancelled: "تم إلغاء الاستيراد.", importParseFailed: "فشل الاستيراد: الملف ليس حمولة JSON لتصدير الجلسات.", importFailed: "فشل الاستيراد: {error}", msgCount: "{count} رسالة", project: "المشروع", source: "المصدر", metaEnded: "انتهت", metaDuration: "المدة", stats: "{sessions} جلسة \u00b7 {messages} رسالة \u00b7 {size} على القرص",
    ...
    forkTitle: "تفريع هذه الجلسة إلى فرع جديد", forked: "تم التفريع باسم {id}", forkFailed: "فشل التفريع: {error}", openInChat: "← الدردشة", openInChatTitle: "فتح هذه الجلسة في عرض الدردشة",
    ...
    renameTitle: "إعادة تسمية هذه الجلسة", retitleTitle: "إعادة توليد العنوان عبر LLM", retitleApplied: "تمت إعادة توليد العنوان: {label}", retitleUnchanged: "العنوان محدث بالفعل.", retitleFailed: "فشلت إعادة توليد العنوان (تعذر الوصول إلى المزود أو تم الرفض).", renamePrompt: "العنوان الجديد (فارغ للمسح):", renamed: "تمت إعادة تسمية الجلسة.", renameFailed: "فشل إعادة التسمية: {error}",
  },
  modelsView: {
  ...
  computerUsePanel: { title: "التحكم بالحاسوب", driver: "برنامج التشغيل", notInstalled: "غير مثبت", telemetry: "القياس عن بعد", maxDimension: "أقصى بُعد للصورة", captureAfter: "الالتقاط بعد", overlay: "التراكب", overlayAuto: "تلقائي", overlayOn: "تشغيل إجباري", overlayOff: "إيقاف إجباري", runDoctor: "تشغيل الفحص", running: "جارٍ التشغيل…", overall: "الإجمالي" },
    computerUseSettingsPanel: { title: "إعدادات التحكم بالحاسوب", disabledWord: "معطّل", apply: "طبّق", clear: "امسح" },
  secretsPanel: { title: "مصادر الأسرار", order: "ترتيب المصادر", noneEnabled: "لا مصادر مفعلة", configured: "مُهيأ", noCommand: "لم يُضبط أمر", bwsMissing: "bws غير موجود", tokenPresent: "الرمز موجود", tokenMissing: "الرمز مفقود", opMissing: "op غير موجود", bindingsWord: "ربطًا", tokenOptional: "بلا رمز خدمة (قد يعمل الاستيثاق التفاعلي)", preserve: "الاحتفاظ بالقيم الحالية" , syncNow: "زامِن الآن", applyNow: "طبّق في .env", syncing: "جارٍ التزامن…", applying: "جارٍ التطبيق…", dryRunNote: "تشغيل تجريبي — لم يُكتب شيء؛ يثبّت التطبيق القيم الفائزة في .env.", applyNote: "تم التثبيت في .env — تُحمَّل القيم عند بدء البوابة التالي.", appliedLabel: "المطبَّقة", skippedExistingLabel: "متجاوزة (معيّنة مسبقًا)", skippedProtectedLabel: "متجاوزة (محمية)", conflictsLabel: "التعارضات", errorsLabel: "الأخطاء", persistedLabel: "المثبَّتة", noneWord: "لا شيء", secretsWord: "أسرار" },
  syncPanel: { title: "مزامنة المهارات", device: "الجهاز", unnamed: "بلا اسم", gate: "البوابة", gateActive: "نشطة", gateInert: "خاملة", optedIn: "المنضمّة", noneOptedIn: "لا شيء (ulnclaw sync enable <skill>)", fetchRemote: "جلب البعيد", fetching: "جارٍ الجلب…", remoteUnavailable: "قائمة المهارات البعيدة غير متاحة", remoteEmpty: "قائمة المهارات البعيدة فارغة.", fromWord: "من", filesWord: "ملف(ات)" , pull: "اسحب الآن", push: "ادفع الآن", pulling: "جارٍ السحب…", pushing: "جارٍ الدفع…", pulledWord: "المسحوب", pushedWord: "المدفوع", nothingNew: "لا جديد للسحب.", nothingToPush: "لا شيء للدفع." },
  ...
  desktopShell: { aboutTitle: "حول ulnclaw", aboutBody: "غلاف سطح المكتب v{version} · منفذ البوابة {port} · الملف الثنائي: {binary}", binaryNotFound: "غير موجود", zoomChanged: "التكبير: {percent}%", quitGuard: "لا يزال هناك دور قيد التشغيل — الخروج الآن سيقطعه. هل تريد الخروج على أي حال؟" },
  metricsPanel: { title: "مقاييس Prometheus", summary: "عرض إخراج /metrics الخام" },
  egressPanel: { title: "وكيل الخروج" },
  channelsPanel: { title: "قنوات المراسلة", enabled: "مفعلة", disabled: "معطلة", noneEnabled: "(لا شيء)", test: "اختبار", stateConnected: "متصل", stateNotConfigured: "غير مهيأ", summary: "المتصلة", summaryValue: "متصلة {connected}/{enabled}", homeChannel: "الرئيسية", knownChannels: "{count} معروفة", recent: "النشاط الأخير" , envTitle: "متغيرات البيئة", envNotSet: "غير مضبوط", envPlaceholder: "قيمة جديدة", envReplace: "قيمة بديلة", envSet: "اضبط", envClear: "امسح", envNote: "القيم للكتابة فقط (يعيد GET معاينات مقنّعة)؛ أعد تشغيل البوابة للتطبيق." },
  gatewayHealth: { title: "صحة البوابة", ok: "سليم", degraded: "متدهور", overall: "الحالة العامة", stateDb: "مخزن الجلسات", config: "الإعدادات", model: "النموذج", disk: "القرص", gateway: "المنصات", queues: "قوائم الخلفية", usedPercent: "الاستخدام {pct}%", connectedPlatforms: "متصل {connected}/{total}", queueCounts: "نشطة {runs} \u00b7 في الانتظار {queued}", gatewayState: "حالة البوابة", busy: "مشغولة", activeAgents: "الأدوار النشطة", uptime: "مدة التشغيل", pid: "PID", restartLoop: "قاطع حلقة إعادة التشغيل", tripped: "مفصول", calm: "هادئ", previousExit: "الخروج السابق", exitClean: "نظيف", exitUnclean: "غير نظيف", exitUnknown: "غير معروف", codeSkew: "انحراف الكود", codeSkewStale: "قديم" },
  ...
  gatewaySettingsPanel: { title: "إعدادات البوابة", address: "المستمع", apiKey: "مفتاح API", multiplex: "تعدد الملفات الشخصية", profileRoutes: "مسارات الملفات", messageTimestamps: "الطوابع الزمنية للرسائل", loopWatchdog: "مراقب الحلقة", systemdWatchdog: "مراقب systemd", sessionCap: "حد الجلسات", stallTimeout: "مهلة التوقف", envOverride: "تجاوز بيئي", apply: "تطبيق", clear: "مسح" },
  agentSettingsPanel: { title: "إعدادات الوكيل", iterations: "ميزانية التكرار", approvalGate: "بوابة الموافقة", concurrentTools: "الأدوات المتزامنة", contextBudget: "ميزانية السياق", verbose: "السجل التفصيلي", envProbe: "فحص البيئة", reasoning: "جهد الاستدلال", serviceTier: "فئة الخدمة", personality: "الشخصية", defaultWord: "افتراضي", apply: "تطبيق", clear: "مسح" },
  ...
  palette: {
    ...
    openSettings: "فتح إعدادات البوابة…", refreshSessions: "تحديث قائمة الجلسات", restartGateway: "إعادة تشغيل البوابة", gatewayLog: "عرض سجل البوابة", openWorkingDir: "فتح مجلد العمل في مدير الملفات",
    updateCheck: "فحص التحديثات", shortcuts: "اختصارات لوحة المفاتيح", notifications: "سجل الإشعارات", kanbanDispatch: "توزيع مهام كانبان", kanbanDispatched: "توزيع كانبان: {spawned} إطلاق · {promoted} ترقية · {reclaimed} استرداد", kanbanDispatchFailed: "فشل التوزيع: {error}", kanbanQuickAdd: "مهمة كانبان جديدة…", kanbanQuickAddPrompt: "عنوان المهمة:", kanbanQuickAdded: "تم إنشاء مهمة كانبان: {id} — {title}", kanbanQuickAddFailed: "فشل إنشاء مهمة كانبان: {error}", kanbanBoardSwitch: "تبديل لوحة كانبان…", kanbanBoardSwitched: "تم تبديل لوحة كانبان: {board}", kanbanBoardsFailed: "فشل تحميل لوحات كانبان: {error}", kanbanBoardsEmpty: "لا توجد لوحات كانبان متاحة", toggleSidebar: "تبديل الشريط الجانبي", themePicker: "تبديل السمة…", themePickerTitle: "سمة لوحة التحكم", themeFailed: "فشل تحميل السمة: {error}", fontPicker: "تبديل الخط…", fontPickerTitle: "خط لوحة التحكم", fontFailed: "فشل تحميل الخط: {error}", copySessionId: "نسخ معرف الجلسة", openSessionWindow: "فتح الجلسة في نافذة جديدة", exportPickerTitle: "تصدير الجلسة بصيغة…", copyLastReply: "نسخ آخر رد للمساعد", lastReplyCopied: "تم نسخ آخر رد للمساعد.", lastReplyNone: "لا يوجد رد للمساعد لنسخه بعد.", forkSession: "تفريع الجلسة الحالية", sessionForked: "تم تفريع الجلسة: {label}", forkFailed: "فشل تفريع الجلسة: {error}", toggleHideArchived: "تبديل إخفاء الجلسات المؤرشفة", newSessionInProject: "جلسة جديدة في المشروع النشط", noActiveProject: "لا يوجد مشروع نشط — عيّن واحدًا في عرض المشاريع.", projectSessionCreated: "بدأت الجلسة في المشروع: {label}", projectsLoadFailed: "فشل تحميل المشاريع: {error}", archiveSession: "أرشفة الجلسة الحالية", unarchiveSession: "استعادة الجلسة الحالية (إلغاء الأرشفة)", sessionArchived: "تمت أرشفة الجلسة: {label}", sessionUnarchived: "تمت استعادة الجلسة: {label}", sessionArchiveFailed: "فشل أرشفة الجلسة: {error}", viewInSessionsBrowser: "عرض الجلسة الحالية في متصفح الجلسات", markAllRead: "وضع علامة مقروءة على جميع الجلسات", copyTranscript: "نسخ نص الجلسة بصيغة Markdown", copiedTranscript: "تم نسخ النص إلى الحافظة", copyTranscriptFailed: "فشل نسخ النص: {error}", retitleSkills: "إصلاح عناوين جلسات /skill المسربة…", retitleTitle: "إعادة تسمية جلسات /skill — تم فحص {count}", retitleNone: "لم يتم العثور على عناوين /skill مسربة.", retitleRejected: "مرفوض", retitleApply: "تطبيق العناوين الجديدة", retitleClose: "إغلاق", retitleApplied: "تم تطبيق {count} عنوانًا جديدًا", retitleFailed: "فشلت إعادة التسمية: {error}", unreadOnly: "عرض الجلسات غير المقروءة فقط (تبديل)", pinSession: "تثبيت الجلسة الحالية في الأعلى", unpinSession: "إلغاء تثبيت الجلسة الحالية", sessionPinned: "تم تثبيت {label} في الأعلى", sessionUnpinned: "تم إلغاء تثبيت {label}", retitleCurrent: "إعادة توليد عنوان الجلسة عبر LLM", retitledCurrent: "تمت إعادة توليد العنوان: {label}", retitleCurrentUnchanged: "العنوان محدث بالفعل.", retitleCurrentFailed: "فشلت إعادة توليد العنوان (تعذر الوصول إلى المزود أو تم الرفض).", fileTree: "تبديل شجرة الملفات", quickEntry: "الإدخال السريع…",
