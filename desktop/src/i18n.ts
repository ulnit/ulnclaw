...
const en: Translations = {
  chrome: {
    ...
    scModelPicker: "Open the model picker", scNewSession: "New session", scCycle: "Cycle sessions", scArchive: "Archive / unarchive the current session", scExport: "Export the current session", scFileTree: "Toggle the file tree", scQuickEntry: "Open quick entry",
...
const zh: Translations = {
  chrome: {
    ...
    scModelPicker: "打开模型挑选器", scNewSession: "新建会话", scCycle: "循环切换会话", scArchive: "归档/恢复当前会话", scExport: "导出当前会话", scFileTree: "切换文件树", scQuickEntry: "打开快速输入",
...
const zhHant: Translations = {
  chrome: {
    ...
    scModelPicker: "開啟模型挑選器", scNewSession: "新增工作階段", scCycle: "循環切換工作階段", scArchive: "歸檔/恢復目前工作階段", scExport: "匯出目前工作階段", scFileTree: "切換檔案樹", scQuickEntry: "開啟快速輸入",
...
const ja: Translations = {
  chrome: {
    ...
    scModelPicker: "モデルピッカーを開く", scNewSession: "新規セッション", scCycle: "セッションを切り替え", scArchive: "現在のセッションをアーカイブ/復元", scExport: "現在のセッションをエクスポート", scFileTree: "ファイルツリーを切り替え", scQuickEntry: "クイックエントリーを開く",
...
const ar: Translations = {
  chrome: {
    ...
    scModelPicker: "فتح منتقي النماذج", scNewSession: "جلسة جديدة", scCycle: "التنقل بين الجلسات", scArchive: "أرشفة/استعادة الجلسة الحالية", scExport: "تصدير الجلسة الحالية", scFileTree: "تبديل شجرة الملفات", scQuickEntry: "فتح الإدخال السريع",
