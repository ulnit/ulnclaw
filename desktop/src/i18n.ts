...
export interface Translations {
  chrome: {
    ...
    manageProcess: string; reopenLast: string; charWarn: string; replayOnboarding: string; cancel: string; save: string;
