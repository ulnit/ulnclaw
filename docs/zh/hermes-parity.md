...
消息平台网关（Telegram/Discord/Slack/Signal/微信/QQ/元宝/邮件/Mattermost/Matrix）、OAuth 设备流登录 + 技能同步、Tauri 桌面 GUI（`desktop/`，取代 hermes 的 Electron 应用）及其余 CLI 均已移植。`sessions`
