...
cd apps/desktop
XCURSOR_SIZE=24 ULNCLAW_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/ulnclaw-typing
# → /tmp/ulnclaw-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/ulnclaw-typing.before.heapsnapshot
# → /tmp/ulnclaw-typing.after.heapsnapshot
```
