...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @ulnclaw/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@ulnclaw/shared'],
              message: 'Plugins import only @ulnclaw/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
