...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\ulnclaw\ulnclaw-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@ulnclaw/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@ulnclaw/shared/billing': path.resolve(__dirname, './shared/src/billing-types.ts'),
      '@ulnclaw/shared': path.resolve(__dirname, './shared/src'),
