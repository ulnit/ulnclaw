/**
 * Canonical ulnclaw skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$ULNCLAW_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`ulnclaw_cli/skin_engine.py`),
 ...
 *   • CLI     → `ulnclaw_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
