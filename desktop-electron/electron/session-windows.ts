...
// by main.ts (`setBackgroundThrottling` driven by the merged `ulnclaw:active-work`
...
// (the "ulnclaw idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey ulnclaw" wake word has NO preceding click,
