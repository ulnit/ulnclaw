...
// even though a fresh shell — and the ulnclaw CLI — sees it immediately. The
// desktop's ULNCLAW_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\ulnclaw. Reading
...
//       ULNCLAW_HOME    REG_SZ    F:\ulnclaw\data
//
