 ...
 * startulnclaw() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startulnclaw() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startulnclaw`, re-emits
