...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/ulnclaw'
...
const VERSION = 3
const PREFIX = 'HML' // "ulnclaw Memory Loadout" — namespaces our codes like WoW's leading bytes.
