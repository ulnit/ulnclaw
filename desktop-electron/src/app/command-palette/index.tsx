...
import { getulnclawConfigRecord, listAllProfileSessions } from '@/ulnclaw'
...
// ulnclaw session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
  ...
  const configQuery = useQuery({
    ...
    queryFn: getulnclawConfigRecord
  })
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-ulnclaw',
            keywords: ['update', 'upgrade', 'ulnclaw', 'version', 'system', 'restart'],
            label: cc.updateulnclaw,
