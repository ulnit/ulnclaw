import type { ulnclawReviewFile } from '@/global'
...
export function buildReviewFlatList(files: ulnclawReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: ulnclawReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
