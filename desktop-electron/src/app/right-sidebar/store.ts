...
const TAKEOVER_KEY = 'ulnclaw.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which ulnclaw can't clear via the API — the user
 *  sees exactly what runs instead of ulnclaw silently deleting their creds. */
