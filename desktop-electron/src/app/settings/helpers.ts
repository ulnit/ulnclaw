...
import type { ConfigFieldSchema, ulnclawConfigRecord, ToolsetInfo } from '@/types/ulnclaw'
...
export function getNested(obj: ulnclawConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ulnclawConfigRecord, path: string, value: unknown): ulnclawConfigRecord {
...
function personalityOptions(config: ulnclawConfigRecord): string[] {
...
function commandProviderNames(config: ulnclawConfigRecord, section: 'tts' | 'stt'): string[] {
