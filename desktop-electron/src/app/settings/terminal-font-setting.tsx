...
import { saveulnclawConfig } from '@/ulnclaw'
...
function fontFamilyFromConfig(config: ulnclawConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useulnclawConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<ulnclawConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setulnclawConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="ulnclaw-terminal-font-families"
          ...
          <datalist id="ulnclaw-terminal-font-families">
