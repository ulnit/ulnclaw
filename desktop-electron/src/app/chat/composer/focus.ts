...
const FOCUS_EVENT = 'ulnclaw:composer-focus'
const INSERT_EVENT = 'ulnclaw:composer-insert'
const INSERT_REFS_EVENT = 'ulnclaw:composer-insert-refs'
const SUBMIT_EVENT = 'ulnclaw:composer-submit'
const VOICE_TOGGLE_EVENT = 'ulnclaw:composer-voice-toggle'
const MODEL_MENU_EVENT = 'ulnclaw:composer-model-menu'
