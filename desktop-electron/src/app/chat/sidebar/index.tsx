...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/ulnclaw'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('ulnclaw:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('ulnclaw:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask ulnclaw to
