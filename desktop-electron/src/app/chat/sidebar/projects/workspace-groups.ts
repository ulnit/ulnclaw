...
import type { ProjectInfo, SessionInfo } from '@/ulnclaw'
 ...
 * repo shows its branches/worktrees even when they have no ulnclaw sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: ulnclawGitWorktree[]
): SidebarSessionGroup[] {
