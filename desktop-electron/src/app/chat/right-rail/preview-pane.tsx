        ...
        <>
          <a
            ...
            onClick={event => {
              ...
              void window.ulnclawDesktop?.openExternal(error.url)
            }}
          >
...
export function PreviewPane({
  ...
  const restartServer = useCallback(async () => {
    ...
    // "Ask ulnclaw to restart the server" looked like it did nothing —
  ...
  useEffect(() => {
    if (
      ...
      !window.ulnclawDesktop?.watchPreviewFile ||
      !window.ulnclawDesktop?.onPreviewFileChanged
    ) {
      return
    }
    ...
    const unsubscribe = window.ulnclawDesktop.onPreviewFileChanged(payload => {
    ...
    void window.ulnclawDesktop
      ...
      .then(watch => {
        if (!active) {
          void window.ulnclawDesktop?.stopPreviewFileWatch?.(watch.id)
    ...
    return () => {
      ...
      if (watchId) {
        void window.ulnclawDesktop?.stopPreviewFileWatch?.(watchId)
      }
    }
  ...
  useEffect(() => {
    ...
    webview.setAttribute('partition', 'persist:ulnclaw-preview')
