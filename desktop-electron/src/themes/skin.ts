/**
 * ulnclaw skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$ULNCLAW_HOME/skins/` (or a
 * built-in) resolved by `ulnclaw_cli/skin_engine.py` and pushed to every surface
 ...
 * skin ulnclaw authors from a prompt lights up all three surfaces from one file.
 *
...
import type { ulnclawSkin, SkinColors } from '@ulnclaw/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: ulnclawSkin): DesktopTheme | null {
