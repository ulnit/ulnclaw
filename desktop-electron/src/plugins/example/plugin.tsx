 ...
 * `src/plugins/` with a `plugin.tsx` that default-exports a `ulnclawPlugin` is
 ...
 *
 * The ONLY import surface is `@ulnclaw/plugin-sdk` (lint-enforced) — the
