 ...
 * `<ulnclaw home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'ulnclaw.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'ulnclaw.desktop.disabledPlugins.v1'
