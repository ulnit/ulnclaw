...
export interface PetInfo {
  ...
  // the ulnclaw "run" activity state uses the in-place running row).
 ...
 * ULNCLAW_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'ulnclaw.desktop.pet-roam.v1'
