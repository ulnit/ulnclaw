...
const POPOUT_STORAGE_KEY = 'ulnclaw.desktop.composerPopout.zones.v1'
...
const LEGACY_ENABLED_KEY = 'ulnclaw.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'ulnclaw.desktop.composerPopout.position'
