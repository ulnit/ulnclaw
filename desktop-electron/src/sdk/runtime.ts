 ...
 * plugins resolve `@ulnclaw/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __ULNCLAW_PLUGIN_SDK__: sdk,
  __ULNCLAW_REACT__: React,
  __ULNCLAW_REACT_JSX__: jsxRuntime,
  __ULNCLAW_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@ulnclaw/plugin-sdk': shimUrl('__ULNCLAW_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__ULNCLAW_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__ULNCLAW_REACT_JSX__'),
    react: shimUrl('__ULNCLAW_REACT__')
  }
