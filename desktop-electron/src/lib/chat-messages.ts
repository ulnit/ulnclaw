...
import { type BillingBlock, skillInvocationText } from '@ulnclaw/shared'
...
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/ulnclaw'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @ulnclaw/shared BillingBlock).
