...
export const en: Translations = {
  ...
  boot: {
    ready: 'ulnclaw Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading ulnclaw settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingulnclawDesktop: 'Starting ulnclaw Desktop…'
    },
    errors: {
      backgroundExited: 'ulnclaw background process exited.',
      backgroundExitedDuringStartup: 'ulnclaw background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your ulnclaw backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateulnclaw: 'Update ulnclaw',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting ulnclaw Desktop.',
    ...
    native: {
      ...
      inputBody: 'ulnclaw is waiting for your response.',
      turnDoneTitle: 'ulnclaw finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to ulnclaw defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while ulnclaw is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'ulnclaw asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while ulnclaw was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let ulnclaw follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and ulnclaw can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what ulnclaw is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen ulnclaw, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'ulnclaw checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading ulnclaw configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening ulnclaw.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a ulnclaw backend elsewhere. Per-profile overrides below.',
      ...
      envOverrideDesc:
        'Unset ULNCLAW_DESKTOP_REMOTE_URL and ULNCLAW_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private ulnclaw backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote ulnclaw backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'ulnclaw Cloud',
      cloudDesc: 'Sign in once to ulnclaw Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'ulnclaw Cloud',
      cloudSignIn: 'Sign in to ulnclaw Cloud',
      cloudSignedIn: 'Signed in to ulnclaw Cloud',
      cloudNeedsSignIn: 'Sign in to ulnclaw Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your ulnclaw Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'ulnclaw Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of ulnclaw Cloud',
      cloudSignedOutMessage: 'Cleared the ulnclaw Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /ulnclaw.',
      ...
      restartingMessage: 'ulnclaw Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · ulnclaw ${version}` : ''}`,
      ...
      sshDesc:
        'ulnclaw is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshulnclawPathTitle: 'ulnclaw path (optional)',
      sshulnclawPathDesc: 'Full path to the remote ulnclaw binary. Blank = auto-detect.',
      sshulnclawPathPlaceholder: 'auto-detect',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — ulnclaw found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — ulnclaw runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'ulnclaw is not installed on the remote host. Install it there (curl -fsSL https://ulnclaw-agent.nousresearch.com/install.sh | sh) or set the ulnclaw path.',
      sshErrPlatform:
        'Unsupported remote platform. ulnclaw Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update ulnclaw on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. ulnclaw runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point ulnclaw at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via ulnclaw curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As ulnclaw builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart ulnclaw to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update ulnclaw to generate pets.',
      backgroundHint: 'You can close this — ulnclaw will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure ulnclaw desktop' },
    ...
    ulnclawActiveSessions: (version, count) => `ulnclaw ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@ulnclaw:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent ulnclaw environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. ulnclaw will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the ulnclaw backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from ulnclaw. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting ulnclaw...',
    placeholderReconnecting: 'Reconnecting to ulnclaw…',
    ...
    attachUrlDesc: 'ulnclaw will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask ulnclaw to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating ulnclaw…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting ulnclaw…',
    ...
    unsupportedMessage: 'This version of ulnclaw can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of ulnclaw is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected ulnclaw backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed ulnclaw from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'ulnclaw will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the ulnclaw desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The ulnclaw updater takes over in its own window and reopens ulnclaw automatically when it’s done. Please don’t reopen ulnclaw yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. ulnclaw reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then ulnclaw reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'ulnclaw needs a one-time install',
    ...
    setupChoiceTitle: 'Set up ulnclaw Desktop',
    setupChoiceDesc:
      'Connect this app to a ulnclaw gateway you already run, or install ulnclaw locally on this computer.',
    connectExistingTitle: 'Connect to existing ulnclaw',
    ...
    installLocalTitle: 'Install ulnclaw locally',
    installLocalDesc: 'Download ulnclaw, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart ulnclaw Desktop and try again.',
    remoteSetupTitle: 'Connect to existing ulnclaw',
    remoteSetupDesc: 'Enter your gateway URL. ulnclaw Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the ulnclaw gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/ulnclaw',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that ulnclaw gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up ulnclaw Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another ulnclaw CLI or desktop instance is running. Stop any running ulnclaw instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The ulnclaw installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with ulnclaw Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'ulnclaw is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting ulnclaw…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run ulnclaw',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point ulnclaw at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — ulnclaw connects automatically',
    ...
    authorizeThere: 'Authorize ulnclaw there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize ulnclaw there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `ulnclaw Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `ulnclaw Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. ulnclaw will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'ulnclaw is restarting...',
      askRestart: 'Ask ulnclaw to restart the server',
      lookingRestart: taskId => `ulnclaw is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'ulnclaw is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `ulnclaw finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'ulnclaw could not restart the server.',
      stillWorking:
        'ulnclaw is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'ulnclaw is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'ulnclaw gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.ulnclaw/config.yaml). ulnclaw won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'ulnclaw needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'ulnclaw needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart ulnclaw Desktop to use Save Image.',
    restartToSaveImages: 'Restart ulnclaw Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `ulnclaw gateway` running?'
    }
  },
