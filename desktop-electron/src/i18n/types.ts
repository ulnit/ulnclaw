...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshulnclawPathTitle: string
      sshulnclawPathDesc: string
      sshulnclawPathPlaceholder: string
  ...
  commandCenter: {
    ...
    ulnclawActiveSessions: (version: string, count: number) => string
