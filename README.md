...
complete, including the messaging-platform gateways (Telegram/Discord/Slack/Signal/Weixin/QQ/Yuanbao/Email/Mattermost/Matrix/DingTalk/WeCom/Feishu/Home Assistant/SMS (Twilio)/WhatsApp (Baileys bridge)/IRC/ntfy/SimpleX/Teams/LINE/Google Chat),
...
# ([messaging.telegram|discord|slack|signal|weixin|qq|yuanbao|email|mattermost|matrix|dingtalk|wecom|homeassistant|whatsapp|irc|ntfy|simplex],
#  plus webhook platforms: whatsapp_cloud/msgraph/webhook/bluebubbles/feishu/sms/teams/line/google_chat)
...
对齐已完成，含消息平台网关（Telegram/Discord/Slack/Signal/微信/QQ/元宝/邮件/Mattermost/Matrix/钉钉/企微/飞书）、插件与 shell 钩子
...
# 消息平台随网关运行
# （[messaging.telegram|discord|slack|signal|weixin|qq|yuanbao|email|mattermost|matrix|dingtalk|wecom|homeassistant|whatsapp|irc|ntfy|simplex]，
#  另有 webhook 平台：whatsapp_cloud/msgraph/webhook/bluebubbles/feishu/sms/teams/line/google_chat）
