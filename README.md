...
# Interactive chat (slash commands: /new /search /memory /skills /sessions /rollback /diff /recap /goal /subgoal /focus /verbose /stash /pet /hatch /paste ...)
./ulnclaw chat
...
# 交互式聊天（斜杠命令：/new /search /memory /skills /sessions /rollback /diff /recap /goal /subgoal /focus /verbose /stash /pet /hatch /paste ……）
./ulnclaw chat
