...
complete, including the messaging-platform gateways (Telegram/Discord/Slack/Signal/Weixin/QQ/Yuanbao/Email/Mattermost/Matrix),
...
# ([messaging.telegram|discord|slack|signal|weixin|qq|yuanbao|email|mattermost|matrix],
#  plus webhook platforms: whatsapp_cloud/msgraph/webhook/bluebubbles)
...
对齐已完成，含消息平台网关（Telegram/Discord/Slack/Signal/微信/QQ/元宝/邮件/Mattermost/Matrix）、插件与 shell 钩子
...
# 消息平台随网关运行
# （[messaging.telegram|discord|slack|signal|weixin|qq|yuanbao|email|mattermost|matrix]，
#  另有 webhook 平台：whatsapp_cloud/msgraph/webhook/bluebubbles）
