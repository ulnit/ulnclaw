...
complete, including the messaging-platform gateways (Telegram/Discord/Slack/Signal/Weixin/QQ/Yuanbao/Email/Mattermost/Matrix/DingTalk/WeCom/Feishu),
...
# ([messaging.telegram|discord|slack|signal|weixin|qq|yuanbao|email|mattermost|matrix|dingtalk|wecom],
...
# 消息平台随网关运行
# （[messaging.telegram|discord|slack|signal|weixin|qq|yuanbao|email|mattermost|matrix|dingtalk|wecom]，
#  另有 webhook 平台：whatsapp_cloud/msgraph/webhook/bluebubbles/feishu）
